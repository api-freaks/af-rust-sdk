...
pub enum TimezoneLookupRequestLang {
    En,
    De,
    Ru,
    Ja,
...
impl Serialize for TimezoneLookupRequestLang {
...
impl<'de> Deserialize<'de> for TimezoneLookupRequestLang {
...
impl fmt::Display for TimezoneLookupRequestLang {
