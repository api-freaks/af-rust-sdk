...
pub struct AstronomyLookupResponseAstronomyMorning {
...
impl AstronomyLookupResponseAstronomyMorning {
    pub fn builder() -> AstronomyLookupResponseAstronomyMorningBuilder {
        <AstronomyLookupResponseAstronomyMorningBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AstronomyLookupResponseAstronomyMorningBuilder {
...
impl AstronomyLookupResponseAstronomyMorningBuilder {
    ...
    /// Consumes the builder and constructs a [`AstronomyLookupResponseAstronomyMorning`].
    pub fn build(self) -> Result<AstronomyLookupResponseAstronomyMorning, BuildError> {
        Ok(AstronomyLookupResponseAstronomyMorning {
