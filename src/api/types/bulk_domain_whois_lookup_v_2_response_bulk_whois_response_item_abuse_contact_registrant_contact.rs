...
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistrantContact {
    /// Contact ID.
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistrantContact {
    pub fn builder(
    ) -> BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistrantContactBuilder
    {
        <BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistrantContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistrantContactBuilder
{
    id: Option<String>,
    name: Option<String>,
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistrantContactBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistrantContact`].
    pub fn build(
        self,
    ) -> Result<
