...
pub struct PdfConvertToTiffRequest {
    ...
    pub api_key: String,
    #[serde(skip_serializing)]
    pub format: Option<PdfConvertToTiffRequestFormat>,
    #[serde(skip_serializing)]
    ...
    #[serde(skip_serializing)]
    pub profile: Option<PdfConvertToTiffRequestProfile>,
    #[serde(skip_serializing)]
    pub webhook_url: Option<String>,
    #[serde(skip_serializing)]
    pub webhook_failure_notification: Option<bool>,
}
impl PdfConvertToTiffRequest {
...
impl PdfConvertToTiffRequest {
    pub fn builder() -> PdfConvertToTiffRequestBuilder {
        <PdfConvertToTiffRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PdfConvertToTiffRequestBuilder {
    file: Option<Vec<u8>>,
    api_key: Option<String>,
    format: Option<PdfConvertToTiffRequestFormat>,
    ...
    profile: Option<PdfConvertToTiffRequestProfile>,
    webhook_url: Option<String>,
    webhook_failure_notification: Option<bool>,
}

impl PdfConvertToTiffRequestBuilder {
    ...
    pub fn format(mut self, value: PdfConvertToTiffRequestFormat) -> Self {
    ...
    pub fn profile(mut self, value: PdfConvertToTiffRequestProfile) -> Self {
    ...
    /// Consumes the builder and constructs a [`PdfConvertToTiffRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`api_key`](PdfConvertToTiffRequestBuilder::api_key)
    pub fn build(self) -> Result<PdfConvertToTiffRequest, BuildError> {
        Ok(PdfConvertToTiffRequest {
            file: self.file,
            api_key: self
                .api_key
