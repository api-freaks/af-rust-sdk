...
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAdministrativeContact {
    /// Contact ID.
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAdministrativeContact {
    pub fn builder(
    ) -> BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAdministrativeContactBuilder
    {
        <BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAdministrativeContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAdministrativeContactBuilder
{
    id: Option<String>,
    name: Option<String>,
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAdministrativeContactBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAdministrativeContact`].
    pub fn build(
        self,
    ) -> Result<
