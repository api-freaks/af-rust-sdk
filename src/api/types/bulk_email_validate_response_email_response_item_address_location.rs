...
pub struct BulkEmailValidateResponseEmailResponseItemAddressLocation {
...
impl BulkEmailValidateResponseEmailResponseItemAddressLocation {
    pub fn builder() -> BulkEmailValidateResponseEmailResponseItemAddressLocationBuilder {
        <BulkEmailValidateResponseEmailResponseItemAddressLocationBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkEmailValidateResponseEmailResponseItemAddressLocationBuilder {
    city: Option<String>,
...
impl BulkEmailValidateResponseEmailResponseItemAddressLocationBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkEmailValidateResponseEmailResponseItemAddressLocation`].
    pub fn build(
        self,
    ) -> Result<BulkEmailValidateResponseEmailResponseItemAddressLocation, BuildError> {
        Ok(BulkEmailValidateResponseEmailResponseItemAddressLocation {
            city: self.city,
