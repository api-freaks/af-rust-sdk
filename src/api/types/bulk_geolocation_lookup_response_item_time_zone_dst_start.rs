...
pub struct BulkGeolocationLookupResponseItemTimeZoneDstStart {
...
impl BulkGeolocationLookupResponseItemTimeZoneDstStart {
    pub fn builder() -> BulkGeolocationLookupResponseItemTimeZoneDstStartBuilder {
        <BulkGeolocationLookupResponseItemTimeZoneDstStartBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupResponseItemTimeZoneDstStartBuilder {
...
impl BulkGeolocationLookupResponseItemTimeZoneDstStartBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkGeolocationLookupResponseItemTimeZoneDstStart`].
    pub fn build(self) -> Result<BulkGeolocationLookupResponseItemTimeZoneDstStart, BuildError> {
        Ok(BulkGeolocationLookupResponseItemTimeZoneDstStart {
