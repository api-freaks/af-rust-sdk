...
pub struct DomainWhoisLookupV2ResponseRegistryDataDomainRegistrar {
    /// IANA registrar ID.
...
impl DomainWhoisLookupV2ResponseRegistryDataDomainRegistrar {
    pub fn builder() -> DomainWhoisLookupV2ResponseRegistryDataDomainRegistrarBuilder {
        <DomainWhoisLookupV2ResponseRegistryDataDomainRegistrarBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupV2ResponseRegistryDataDomainRegistrarBuilder {
...
impl DomainWhoisLookupV2ResponseRegistryDataDomainRegistrarBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupV2ResponseRegistryDataDomainRegistrar`].
    pub fn build(
        self,
    ) -> Result<DomainWhoisLookupV2ResponseRegistryDataDomainRegistrar, BuildError> {
        Ok(DomainWhoisLookupV2ResponseRegistryDataDomainRegistrar {
