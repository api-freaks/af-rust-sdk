...
pub struct BulkGeolocationLookupV2ResponseItemTimeZoneDstStart {
...
impl BulkGeolocationLookupV2ResponseItemTimeZoneDstStart {
    pub fn builder() -> BulkGeolocationLookupV2ResponseItemTimeZoneDstStartBuilder {
        <BulkGeolocationLookupV2ResponseItemTimeZoneDstStartBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupV2ResponseItemTimeZoneDstStartBuilder {
...
impl BulkGeolocationLookupV2ResponseItemTimeZoneDstStartBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkGeolocationLookupV2ResponseItemTimeZoneDstStart`].
    pub fn build(self) -> Result<BulkGeolocationLookupV2ResponseItemTimeZoneDstStart, BuildError> {
        Ok(BulkGeolocationLookupV2ResponseItemTimeZoneDstStart {
