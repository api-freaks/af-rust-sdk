...
pub struct EmailValidateResponseAddressLocation {
...
impl EmailValidateResponseAddressLocation {
    pub fn builder() -> EmailValidateResponseAddressLocationBuilder {
        <EmailValidateResponseAddressLocationBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct EmailValidateResponseAddressLocationBuilder {
    city: Option<String>,
...
impl EmailValidateResponseAddressLocationBuilder {
    ...
    /// Consumes the builder and constructs a [`EmailValidateResponseAddressLocation`].
    pub fn build(self) -> Result<EmailValidateResponseAddressLocation, BuildError> {
        Ok(EmailValidateResponseAddressLocation {
            city: self.city,
