...
pub struct WeatherTimeSeriesResponseLocationZero {
...
impl WeatherTimeSeriesResponseLocationZero {
    pub fn builder() -> WeatherTimeSeriesResponseLocationZeroBuilder {
        <WeatherTimeSeriesResponseLocationZeroBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct WeatherTimeSeriesResponseLocationZeroBuilder {
    latitude: Option<f64>,
...
impl WeatherTimeSeriesResponseLocationZeroBuilder {
    ...
    /// Consumes the builder and constructs a [`WeatherTimeSeriesResponseLocationZero`].
    /// This method will fail if any of the following fields are not set:
    /// - [`latitude`](WeatherTimeSeriesResponseLocationZeroBuilder::latitude)
    /// - [`longitude`](WeatherTimeSeriesResponseLocationZeroBuilder::longitude)
    /// - [`country_name`](WeatherTimeSeriesResponseLocationZeroBuilder::country_name)
    /// - [`state_prov`](WeatherTimeSeriesResponseLocationZeroBuilder::state_prov)
    /// - [`city`](WeatherTimeSeriesResponseLocationZeroBuilder::city)
    /// - [`timezone`](WeatherTimeSeriesResponseLocationZeroBuilder::timezone)
    /// - [`timezone_abbreviation`](WeatherTimeSeriesResponseLocationZeroBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<WeatherTimeSeriesResponseLocationZero, BuildError> {
        Ok(WeatherTimeSeriesResponseLocationZero {
            latitude: self
                .latitude
