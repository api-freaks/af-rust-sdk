...
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBillingContact {
    /// Contact's full name.
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBillingContact {
    pub fn builder(
    ) -> BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBillingContactBuilder {
        <BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBillingContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBillingContactBuilder {
    name: Option<String>,
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBillingContactBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBillingContact`].
    pub fn build(
        self,
    ) -> Result<
