...
pub struct PdfConvertToGifRequest {
    ...
    pub api_key: String,
    #[serde(skip_serializing)]
    pub format: Option<PdfConvertToGifRequestFormat>,
    #[serde(skip_serializing)]
    ...
    #[serde(skip_serializing)]
    pub profile: Option<PdfConvertToGifRequestProfile>,
    #[serde(skip_serializing)]
    pub webhook_url: Option<String>,
    #[serde(skip_serializing)]
    pub webhook_failure_notification: Option<bool>,
}
impl PdfConvertToGifRequest {
...
impl PdfConvertToGifRequest {
    pub fn builder() -> PdfConvertToGifRequestBuilder {
        <PdfConvertToGifRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PdfConvertToGifRequestBuilder {
    file: Option<Vec<u8>>,
    api_key: Option<String>,
    format: Option<PdfConvertToGifRequestFormat>,
    ...
    profile: Option<PdfConvertToGifRequestProfile>,
    webhook_url: Option<String>,
    webhook_failure_notification: Option<bool>,
}

impl PdfConvertToGifRequestBuilder {
    ...
    pub fn format(mut self, value: PdfConvertToGifRequestFormat) -> Self {
    ...
    pub fn profile(mut self, value: PdfConvertToGifRequestProfile) -> Self {
    ...
    /// Consumes the builder and constructs a [`PdfConvertToGifRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`api_key`](PdfConvertToGifRequestBuilder::api_key)
    pub fn build(self) -> Result<PdfConvertToGifRequest, BuildError> {
        Ok(PdfConvertToGifRequest {
            file: self.file,
            api_key: self
                .api_key
