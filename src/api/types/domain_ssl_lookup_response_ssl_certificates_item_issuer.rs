...
pub struct DomainSslLookupResponseSslCertificatesItemIssuer {
...
impl DomainSslLookupResponseSslCertificatesItemIssuer {
    pub fn builder() -> DomainSslLookupResponseSslCertificatesItemIssuerBuilder {
        <DomainSslLookupResponseSslCertificatesItemIssuerBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainSslLookupResponseSslCertificatesItemIssuerBuilder {
...
impl DomainSslLookupResponseSslCertificatesItemIssuerBuilder {
