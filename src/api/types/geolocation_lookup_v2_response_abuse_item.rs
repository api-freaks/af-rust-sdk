...
pub struct GeolocationLookupV2ResponseAbuseItem {
...
impl GeolocationLookupV2ResponseAbuseItem {
    pub fn builder() -> GeolocationLookupV2ResponseAbuseItemBuilder {
        <GeolocationLookupV2ResponseAbuseItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GeolocationLookupV2ResponseAbuseItemBuilder {
    route: Option<String>,
...
impl GeolocationLookupV2ResponseAbuseItemBuilder {
    ...
    /// Consumes the builder and constructs a [`GeolocationLookupV2ResponseAbuseItem`].
    pub fn build(self) -> Result<GeolocationLookupV2ResponseAbuseItem, BuildError> {
        Ok(GeolocationLookupV2ResponseAbuseItem {
            route: self.route,
