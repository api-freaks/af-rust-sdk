...
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrar {
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrar {
    pub fn builder(
    ) -> BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrarBuilder {
        <BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrarBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrarBuilder {
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrarBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrar`].
    pub fn build(
        self,
    ) -> Result<
        BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrar,
        BuildError,
    > {
        Ok(
            BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrar {
