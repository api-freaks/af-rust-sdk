...
pub struct HistoricalWeatherResponseLocationZero {
...
impl HistoricalWeatherResponseLocationZero {
    pub fn builder() -> HistoricalWeatherResponseLocationZeroBuilder {
        <HistoricalWeatherResponseLocationZeroBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct HistoricalWeatherResponseLocationZeroBuilder {
    latitude: Option<f64>,
...
impl HistoricalWeatherResponseLocationZeroBuilder {
    ...
    /// Consumes the builder and constructs a [`HistoricalWeatherResponseLocationZero`].
    /// This method will fail if any of the following fields are not set:
    /// - [`latitude`](HistoricalWeatherResponseLocationZeroBuilder::latitude)
    /// - [`longitude`](HistoricalWeatherResponseLocationZeroBuilder::longitude)
    /// - [`country_name`](HistoricalWeatherResponseLocationZeroBuilder::country_name)
    /// - [`state_prov`](HistoricalWeatherResponseLocationZeroBuilder::state_prov)
    /// - [`city`](HistoricalWeatherResponseLocationZeroBuilder::city)
    /// - [`timezone`](HistoricalWeatherResponseLocationZeroBuilder::timezone)
    /// - [`timezone_abbreviation`](HistoricalWeatherResponseLocationZeroBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<HistoricalWeatherResponseLocationZero, BuildError> {
        Ok(HistoricalWeatherResponseLocationZero {
            latitude: self
                .latitude
