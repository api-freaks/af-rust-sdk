...
pub struct DomainWhoisLookupResponseRegistryData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub domain_registered: Option<DomainWhoisLookupResponseRegistryDataDomainRegistered>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub domain_registrar: Option<DomainWhoisLookupResponseRegistryDataDomainRegistrar>,
}

impl DomainWhoisLookupResponseRegistryData {
    pub fn builder() -> DomainWhoisLookupResponseRegistryDataBuilder {
        <DomainWhoisLookupResponseRegistryDataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupResponseRegistryDataBuilder {
    domain_name: Option<String>,
    query_time: Option<DateTime<FixedOffset>>,
    whois_server: Option<String>,
    domain_registered: Option<DomainWhoisLookupResponseRegistryDataDomainRegistered>,
    ...
    domain_registrar: Option<DomainWhoisLookupResponseRegistryDataDomainRegistrar>,
}

impl DomainWhoisLookupResponseRegistryDataBuilder {
    ...
    pub fn domain_registered(
        mut self,
        value: DomainWhoisLookupResponseRegistryDataDomainRegistered,
    ) -> Self {
    ...
    pub fn domain_registrar(
        mut self,
        value: DomainWhoisLookupResponseRegistryDataDomainRegistrar,
    ) -> Self {
        self.domain_registrar = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`DomainWhoisLookupResponseRegistryData`].
    pub fn build(self) -> Result<DomainWhoisLookupResponseRegistryData, BuildError> {
        Ok(DomainWhoisLookupResponseRegistryData {
