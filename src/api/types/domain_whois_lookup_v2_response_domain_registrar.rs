...
pub struct DomainWhoisLookupV2ResponseDomainRegistrar {
...
impl DomainWhoisLookupV2ResponseDomainRegistrar {
    pub fn builder() -> DomainWhoisLookupV2ResponseDomainRegistrarBuilder {
        <DomainWhoisLookupV2ResponseDomainRegistrarBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupV2ResponseDomainRegistrarBuilder {
...
impl DomainWhoisLookupV2ResponseDomainRegistrarBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupV2ResponseDomainRegistrar`].
    pub fn build(self) -> Result<DomainWhoisLookupV2ResponseDomainRegistrar, BuildError> {
        Ok(DomainWhoisLookupV2ResponseDomainRegistrar {
