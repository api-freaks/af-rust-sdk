...
pub struct IpSecurityLookupResponseSecurity {
...
impl IpSecurityLookupResponseSecurity {
    pub fn builder() -> IpSecurityLookupResponseSecurityBuilder {
        <IpSecurityLookupResponseSecurityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct IpSecurityLookupResponseSecurityBuilder {
...
impl IpSecurityLookupResponseSecurityBuilder {
    ...
    /// Consumes the builder and constructs a [`IpSecurityLookupResponseSecurity`].
    pub fn build(self) -> Result<IpSecurityLookupResponseSecurity, BuildError> {
        Ok(IpSecurityLookupResponseSecurity {
