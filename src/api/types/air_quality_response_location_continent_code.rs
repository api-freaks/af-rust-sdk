...
pub struct AirQualityResponseLocationContinentCode {
...
impl AirQualityResponseLocationContinentCode {
    pub fn builder() -> AirQualityResponseLocationContinentCodeBuilder {
        <AirQualityResponseLocationContinentCodeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AirQualityResponseLocationContinentCodeBuilder {
...
impl AirQualityResponseLocationContinentCodeBuilder {
    ...
    /// Consumes the builder and constructs a [`AirQualityResponseLocationContinentCode`].
    /// This method will fail if any of the following fields are not set:
    /// - [`continent_code`](AirQualityResponseLocationContinentCodeBuilder::continent_code)
    /// - [`continent_name`](AirQualityResponseLocationContinentCodeBuilder::continent_name)
    /// - [`country_code2`](AirQualityResponseLocationContinentCodeBuilder::country_code2)
    /// - [`country_code3`](AirQualityResponseLocationContinentCodeBuilder::country_code3)
    /// - [`country_name`](AirQualityResponseLocationContinentCodeBuilder::country_name)
    /// - [`country_name_official`](AirQualityResponseLocationContinentCodeBuilder::country_name_official)
    /// - [`state_prov`](AirQualityResponseLocationContinentCodeBuilder::state_prov)
    /// - [`city`](AirQualityResponseLocationContinentCodeBuilder::city)
    /// - [`latitude`](AirQualityResponseLocationContinentCodeBuilder::latitude)
    /// - [`longitude`](AirQualityResponseLocationContinentCodeBuilder::longitude)
    /// - [`timezone`](AirQualityResponseLocationContinentCodeBuilder::timezone)
    /// - [`timezone_abbreviation`](AirQualityResponseLocationContinentCodeBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<AirQualityResponseLocationContinentCode, BuildError> {
        Ok(AirQualityResponseLocationContinentCode {
            continent_code: self
                .continent_code
