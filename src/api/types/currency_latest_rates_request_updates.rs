...
pub enum CurrencyLatestRatesRequestUpdates {
    OneD,
    OneH,
    TenM,
    OneM,
...
impl Serialize for CurrencyLatestRatesRequestUpdates {
...
impl<'de> Deserialize<'de> for CurrencyLatestRatesRequestUpdates {
...
impl fmt::Display for CurrencyLatestRatesRequestUpdates {
