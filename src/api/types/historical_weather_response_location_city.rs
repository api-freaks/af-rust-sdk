...
pub struct HistoricalWeatherResponseLocationCity {
...
impl HistoricalWeatherResponseLocationCity {
    pub fn builder() -> HistoricalWeatherResponseLocationCityBuilder {
        <HistoricalWeatherResponseLocationCityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct HistoricalWeatherResponseLocationCityBuilder {
...
impl HistoricalWeatherResponseLocationCityBuilder {
    ...
    /// Consumes the builder and constructs a [`HistoricalWeatherResponseLocationCity`].
    /// This method will fail if any of the following fields are not set:
    /// - [`location_string`](HistoricalWeatherResponseLocationCityBuilder::location_string)
    /// - [`country_name`](HistoricalWeatherResponseLocationCityBuilder::country_name)
    /// - [`state_prov`](HistoricalWeatherResponseLocationCityBuilder::state_prov)
    /// - [`city`](HistoricalWeatherResponseLocationCityBuilder::city)
    /// - [`latitude`](HistoricalWeatherResponseLocationCityBuilder::latitude)
    /// - [`longitude`](HistoricalWeatherResponseLocationCityBuilder::longitude)
    /// - [`timezone`](HistoricalWeatherResponseLocationCityBuilder::timezone)
    /// - [`timezone_abbreviation`](HistoricalWeatherResponseLocationCityBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<HistoricalWeatherResponseLocationCity, BuildError> {
        Ok(HistoricalWeatherResponseLocationCity {
