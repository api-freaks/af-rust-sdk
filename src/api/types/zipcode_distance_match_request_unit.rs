...
pub enum ZipcodeDistanceMatchRequestUnit {
    M,
    Km,
    Mi,
    Ft,
...
impl Serialize for ZipcodeDistanceMatchRequestUnit {
...
impl<'de> Deserialize<'de> for ZipcodeDistanceMatchRequestUnit {
...
impl fmt::Display for ZipcodeDistanceMatchRequestUnit {
