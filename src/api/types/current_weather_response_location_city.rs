...
pub struct CurrentWeatherResponseLocationCity {
...
impl CurrentWeatherResponseLocationCity {
    pub fn builder() -> CurrentWeatherResponseLocationCityBuilder {
        <CurrentWeatherResponseLocationCityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CurrentWeatherResponseLocationCityBuilder {
...
impl CurrentWeatherResponseLocationCityBuilder {
    ...
    /// Consumes the builder and constructs a [`CurrentWeatherResponseLocationCity`].
    /// This method will fail if any of the following fields are not set:
    /// - [`location_string`](CurrentWeatherResponseLocationCityBuilder::location_string)
    /// - [`country_name`](CurrentWeatherResponseLocationCityBuilder::country_name)
    /// - [`state_prov`](CurrentWeatherResponseLocationCityBuilder::state_prov)
    /// - [`city`](CurrentWeatherResponseLocationCityBuilder::city)
    /// - [`latitude`](CurrentWeatherResponseLocationCityBuilder::latitude)
    /// - [`longitude`](CurrentWeatherResponseLocationCityBuilder::longitude)
    /// - [`timezone`](CurrentWeatherResponseLocationCityBuilder::timezone)
    /// - [`timezone_abbreviation`](CurrentWeatherResponseLocationCityBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<CurrentWeatherResponseLocationCity, BuildError> {
        Ok(CurrentWeatherResponseLocationCity {
