...
pub struct BulkGeolocationLookupResponseItemNetworkAsn {
    /// The AS number
...
impl BulkGeolocationLookupResponseItemNetworkAsn {
    pub fn builder() -> BulkGeolocationLookupResponseItemNetworkAsnBuilder {
        <BulkGeolocationLookupResponseItemNetworkAsnBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupResponseItemNetworkAsnBuilder {
...
impl BulkGeolocationLookupResponseItemNetworkAsnBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkGeolocationLookupResponseItemNetworkAsn`].
    pub fn build(self) -> Result<BulkGeolocationLookupResponseItemNetworkAsn, BuildError> {
        Ok(BulkGeolocationLookupResponseItemNetworkAsn {
