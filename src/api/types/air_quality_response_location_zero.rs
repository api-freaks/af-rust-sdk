...
pub struct AirQualityResponseLocationZero {
...
impl AirQualityResponseLocationZero {
    pub fn builder() -> AirQualityResponseLocationZeroBuilder {
        <AirQualityResponseLocationZeroBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AirQualityResponseLocationZeroBuilder {
    latitude: Option<f64>,
...
impl AirQualityResponseLocationZeroBuilder {
    ...
    /// Consumes the builder and constructs a [`AirQualityResponseLocationZero`].
    /// This method will fail if any of the following fields are not set:
    /// - [`latitude`](AirQualityResponseLocationZeroBuilder::latitude)
    /// - [`longitude`](AirQualityResponseLocationZeroBuilder::longitude)
    /// - [`country_name`](AirQualityResponseLocationZeroBuilder::country_name)
    /// - [`state_prov`](AirQualityResponseLocationZeroBuilder::state_prov)
    /// - [`city`](AirQualityResponseLocationZeroBuilder::city)
    /// - [`timezone`](AirQualityResponseLocationZeroBuilder::timezone)
    /// - [`timezone_abbreviation`](AirQualityResponseLocationZeroBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<AirQualityResponseLocationZero, BuildError> {
        Ok(AirQualityResponseLocationZero {
            latitude: self
                .latitude
