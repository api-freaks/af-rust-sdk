...
pub struct GeolocationLookupV2ResponseTimeZoneDstStart {
...
impl GeolocationLookupV2ResponseTimeZoneDstStart {
    pub fn builder() -> GeolocationLookupV2ResponseTimeZoneDstStartBuilder {
        <GeolocationLookupV2ResponseTimeZoneDstStartBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GeolocationLookupV2ResponseTimeZoneDstStartBuilder {
...
impl GeolocationLookupV2ResponseTimeZoneDstStartBuilder {
    ...
    /// Consumes the builder and constructs a [`GeolocationLookupV2ResponseTimeZoneDstStart`].
    pub fn build(self) -> Result<GeolocationLookupV2ResponseTimeZoneDstStart, BuildError> {
        Ok(GeolocationLookupV2ResponseTimeZoneDstStart {
