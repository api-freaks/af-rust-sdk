...
pub struct PdfEncryptRequest {
    ...
    pub api_key: String,
    #[serde(skip_serializing)]
    pub format: Option<PdfEncryptRequestFormat>,
    #[serde(skip_serializing)]
...
impl PdfEncryptRequest {
    pub fn builder() -> PdfEncryptRequestBuilder {
        <PdfEncryptRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PdfEncryptRequestBuilder {
    file: Option<Vec<u8>>,
    api_key: Option<String>,
    format: Option<PdfEncryptRequestFormat>,
...
impl PdfEncryptRequestBuilder {
    ...
    pub fn format(mut self, value: PdfEncryptRequestFormat) -> Self {
    ...
    /// Consumes the builder and constructs a [`PdfEncryptRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`api_key`](PdfEncryptRequestBuilder::api_key)
    /// - [`user_password`](PdfEncryptRequestBuilder::user_password)
    pub fn build(self) -> Result<PdfEncryptRequest, BuildError> {
        Ok(PdfEncryptRequest {
            file: self.file,
            api_key: self
                .api_key
