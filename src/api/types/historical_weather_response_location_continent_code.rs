...
pub struct HistoricalWeatherResponseLocationContinentCode {
...
impl HistoricalWeatherResponseLocationContinentCode {
    pub fn builder() -> HistoricalWeatherResponseLocationContinentCodeBuilder {
        <HistoricalWeatherResponseLocationContinentCodeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct HistoricalWeatherResponseLocationContinentCodeBuilder {
...
impl HistoricalWeatherResponseLocationContinentCodeBuilder {
    ...
    /// Consumes the builder and constructs a [`HistoricalWeatherResponseLocationContinentCode`].
    /// This method will fail if any of the following fields are not set:
    /// - [`continent_code`](HistoricalWeatherResponseLocationContinentCodeBuilder::continent_code)
    /// - [`continent_name`](HistoricalWeatherResponseLocationContinentCodeBuilder::continent_name)
    /// - [`country_code2`](HistoricalWeatherResponseLocationContinentCodeBuilder::country_code2)
    /// - [`country_code3`](HistoricalWeatherResponseLocationContinentCodeBuilder::country_code3)
    /// - [`country_name`](HistoricalWeatherResponseLocationContinentCodeBuilder::country_name)
    /// - [`country_name_official`](HistoricalWeatherResponseLocationContinentCodeBuilder::country_name_official)
    /// - [`state_prov`](HistoricalWeatherResponseLocationContinentCodeBuilder::state_prov)
    /// - [`city`](HistoricalWeatherResponseLocationContinentCodeBuilder::city)
    /// - [`latitude`](HistoricalWeatherResponseLocationContinentCodeBuilder::latitude)
    /// - [`longitude`](HistoricalWeatherResponseLocationContinentCodeBuilder::longitude)
    /// - [`timezone`](HistoricalWeatherResponseLocationContinentCodeBuilder::timezone)
    /// - [`timezone_abbreviation`](HistoricalWeatherResponseLocationContinentCodeBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<HistoricalWeatherResponseLocationContinentCode, BuildError> {
        Ok(HistoricalWeatherResponseLocationContinentCode {
            continent_code: self
                .continent_code
