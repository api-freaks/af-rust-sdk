...
pub struct WeatherTimeSeriesResponseLocationContinentCode {
...
impl WeatherTimeSeriesResponseLocationContinentCode {
    pub fn builder() -> WeatherTimeSeriesResponseLocationContinentCodeBuilder {
        <WeatherTimeSeriesResponseLocationContinentCodeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct WeatherTimeSeriesResponseLocationContinentCodeBuilder {
...
impl WeatherTimeSeriesResponseLocationContinentCodeBuilder {
    ...
    /// Consumes the builder and constructs a [`WeatherTimeSeriesResponseLocationContinentCode`].
    /// This method will fail if any of the following fields are not set:
    /// - [`continent_code`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::continent_code)
    /// - [`continent_name`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::continent_name)
    /// - [`country_code2`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::country_code2)
    /// - [`country_code3`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::country_code3)
    /// - [`country_name`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::country_name)
    /// - [`country_name_official`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::country_name_official)
    /// - [`state_prov`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::state_prov)
    /// - [`city`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::city)
    /// - [`latitude`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::latitude)
    /// - [`longitude`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::longitude)
    /// - [`timezone`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::timezone)
    /// - [`timezone_abbreviation`](WeatherTimeSeriesResponseLocationContinentCodeBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<WeatherTimeSeriesResponseLocationContinentCode, BuildError> {
        Ok(WeatherTimeSeriesResponseLocationContinentCode {
            continent_code: self
                .continent_code
