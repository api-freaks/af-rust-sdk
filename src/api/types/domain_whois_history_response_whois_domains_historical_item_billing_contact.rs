...
pub struct DomainWhoisHistoryResponseWhoisDomainsHistoricalItemBillingContact {
...
impl DomainWhoisHistoryResponseWhoisDomainsHistoricalItemBillingContact {
    pub fn builder() -> DomainWhoisHistoryResponseWhoisDomainsHistoricalItemBillingContactBuilder {
        <DomainWhoisHistoryResponseWhoisDomainsHistoricalItemBillingContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisHistoryResponseWhoisDomainsHistoricalItemBillingContactBuilder {
    name: Option<String>,
...
impl DomainWhoisHistoryResponseWhoisDomainsHistoricalItemBillingContactBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisHistoryResponseWhoisDomainsHistoricalItemBillingContact`].
    pub fn build(
        self,
    ) -> Result<DomainWhoisHistoryResponseWhoisDomainsHistoricalItemBillingContact, BuildError>
    {
        Ok(
