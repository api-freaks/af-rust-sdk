...
pub struct PdfConvertToPngRequest {
    ...
    pub api_key: String,
    #[serde(skip_serializing)]
    pub format: Option<PdfConvertToPngRequestFormat>,
    #[serde(skip_serializing)]
    ...
    #[serde(skip_serializing)]
    pub profile: Option<PdfConvertToPngRequestProfile>,
    #[serde(skip_serializing)]
    pub webhook_url: Option<String>,
    #[serde(skip_serializing)]
    pub webhook_failure_notification: Option<bool>,
}
impl PdfConvertToPngRequest {
...
impl PdfConvertToPngRequest {
    pub fn builder() -> PdfConvertToPngRequestBuilder {
        <PdfConvertToPngRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PdfConvertToPngRequestBuilder {
    file: Option<Vec<u8>>,
    api_key: Option<String>,
    format: Option<PdfConvertToPngRequestFormat>,
    ...
    profile: Option<PdfConvertToPngRequestProfile>,
    webhook_url: Option<String>,
    webhook_failure_notification: Option<bool>,
}

impl PdfConvertToPngRequestBuilder {
    ...
    pub fn format(mut self, value: PdfConvertToPngRequestFormat) -> Self {
    ...
    pub fn profile(mut self, value: PdfConvertToPngRequestProfile) -> Self {
    ...
    /// Consumes the builder and constructs a [`PdfConvertToPngRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`api_key`](PdfConvertToPngRequestBuilder::api_key)
    pub fn build(self) -> Result<PdfConvertToPngRequest, BuildError> {
        Ok(PdfConvertToPngRequest {
            file: self.file,
            api_key: self
                .api_key
