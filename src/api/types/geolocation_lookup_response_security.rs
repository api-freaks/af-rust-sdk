...
pub struct GeolocationLookupResponseSecurity {
...
impl GeolocationLookupResponseSecurity {
    pub fn builder() -> GeolocationLookupResponseSecurityBuilder {
        <GeolocationLookupResponseSecurityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GeolocationLookupResponseSecurityBuilder {
...
impl GeolocationLookupResponseSecurityBuilder {
    ...
    /// Consumes the builder and constructs a [`GeolocationLookupResponseSecurity`].
    pub fn build(self) -> Result<GeolocationLookupResponseSecurity, BuildError> {
        Ok(GeolocationLookupResponseSecurity {
