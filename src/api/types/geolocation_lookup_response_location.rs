...
pub struct GeolocationLookupResponseLocation {
...
impl GeolocationLookupResponseLocation {
    pub fn builder() -> GeolocationLookupResponseLocationBuilder {
        <GeolocationLookupResponseLocationBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GeolocationLookupResponseLocationBuilder {
...
impl GeolocationLookupResponseLocationBuilder {
    ...
    /// Consumes the builder and constructs a [`GeolocationLookupResponseLocation`].
    pub fn build(self) -> Result<GeolocationLookupResponseLocation, BuildError> {
        Ok(GeolocationLookupResponseLocation {
