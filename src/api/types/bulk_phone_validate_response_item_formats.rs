...
pub struct BulkPhoneValidateResponseItemFormats {
...
impl BulkPhoneValidateResponseItemFormats {
    pub fn builder() -> BulkPhoneValidateResponseItemFormatsBuilder {
        <BulkPhoneValidateResponseItemFormatsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkPhoneValidateResponseItemFormatsBuilder {
    e164: Option<String>,
...
impl BulkPhoneValidateResponseItemFormatsBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkPhoneValidateResponseItemFormats`].
    pub fn build(self) -> Result<BulkPhoneValidateResponseItemFormats, BuildError> {
        Ok(BulkPhoneValidateResponseItemFormats {
            e164: self.e164,
