...
pub struct BulkCurrentWeatherResponseBulkItemCurrentAirQuality {
...
impl BulkCurrentWeatherResponseBulkItemCurrentAirQuality {
    pub fn builder() -> BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder {
        <BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder {
...
impl BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkCurrentWeatherResponseBulkItemCurrentAirQuality`].
    /// This method will fail if any of the following fields are not set:
    /// - [`timestamp`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::timestamp)
    /// - [`european_aqi`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::european_aqi)
    /// - [`us_aqi`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::us_aqi)
    /// - [`pm10`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::pm10)
    /// - [`pm25`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::pm25)
    /// - [`carbon_monoxide`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::carbon_monoxide)
    /// - [`nitrogen_dioxide`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::nitrogen_dioxide)
    /// - [`sulphur_dioxide`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::sulphur_dioxide)
    /// - [`ozone`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::ozone)
    /// - [`dust`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::dust)
    /// - [`uv_index`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::uv_index)
    /// - [`aerosol_optical_depth`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::aerosol_optical_depth)
    /// - [`uv_index_clear_sky`](BulkCurrentWeatherResponseBulkItemCurrentAirQualityBuilder::uv_index_clear_sky)
    pub fn build(self) -> Result<BulkCurrentWeatherResponseBulkItemCurrentAirQuality, BuildError> {
        Ok(BulkCurrentWeatherResponseBulkItemCurrentAirQuality {
            timestamp: self
                .timestamp
