...
pub enum PdfConvertToPngRequestProfile {
    Bw,
    Gray,
    Rgb,
    Rgba,
...
impl Serialize for PdfConvertToPngRequestProfile {
...
impl<'de> Deserialize<'de> for PdfConvertToPngRequestProfile {
...
impl fmt::Display for PdfConvertToPngRequestProfile {
