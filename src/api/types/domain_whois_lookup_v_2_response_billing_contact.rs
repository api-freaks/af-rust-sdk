...
pub struct DomainWhoisLookupV2ResponseBillingContact {
    /// Contact's full name.
...
impl DomainWhoisLookupV2ResponseBillingContact {
    pub fn builder() -> DomainWhoisLookupV2ResponseBillingContactBuilder {
        <DomainWhoisLookupV2ResponseBillingContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupV2ResponseBillingContactBuilder {
    name: Option<String>,
...
impl DomainWhoisLookupV2ResponseBillingContactBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupV2ResponseBillingContact`].
    pub fn build(self) -> Result<DomainWhoisLookupV2ResponseBillingContact, BuildError> {
        Ok(DomainWhoisLookupV2ResponseBillingContact {
            name: self.name,
