...
impl FloodForecastResponseLocationZero {
    pub fn builder() -> FloodForecastResponseLocationZeroBuilder {
        <FloodForecastResponseLocationZeroBuilder as Default>::default()
    }
}
...
impl FloodForecastResponseLocationZeroBuilder {
    ...
    /// Consumes the builder and constructs a [`FloodForecastResponseLocationZero`].
    /// This method will fail if any of the following fields are not set:
    /// - [`latitude`](FloodForecastResponseLocationZeroBuilder::latitude)
    /// - [`longitude`](FloodForecastResponseLocationZeroBuilder::longitude)
    /// - [`country_name`](FloodForecastResponseLocationZeroBuilder::country_name)
    /// - [`state_prov`](FloodForecastResponseLocationZeroBuilder::state_prov)
    /// - [`city`](FloodForecastResponseLocationZeroBuilder::city)
    /// - [`timezone`](FloodForecastResponseLocationZeroBuilder::timezone)
    /// - [`timezone_abbreviation`](FloodForecastResponseLocationZeroBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<FloodForecastResponseLocationZero, BuildError> {
        Ok(FloodForecastResponseLocationZero {
            latitude: self
                .latitude
