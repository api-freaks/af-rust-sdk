...
pub struct BulkGeolocationLookupV2ResponseItemAbuseAsn {
...
impl BulkGeolocationLookupV2ResponseItemAbuseAsn {
    pub fn builder() -> BulkGeolocationLookupV2ResponseItemAbuseAsnBuilder {
        <BulkGeolocationLookupV2ResponseItemAbuseAsnBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupV2ResponseItemAbuseAsnBuilder {
...
impl BulkGeolocationLookupV2ResponseItemAbuseAsnBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkGeolocationLookupV2ResponseItemAbuseAsn`].
    pub fn build(self) -> Result<BulkGeolocationLookupV2ResponseItemAbuseAsn, BuildError> {
        Ok(BulkGeolocationLookupV2ResponseItemAbuseAsn {
