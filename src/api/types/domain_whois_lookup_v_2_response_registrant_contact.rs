...
pub struct DomainWhoisLookupV2ResponseRegistrantContact {
    /// Contact ID.
...
impl DomainWhoisLookupV2ResponseRegistrantContact {
    pub fn builder() -> DomainWhoisLookupV2ResponseRegistrantContactBuilder {
        <DomainWhoisLookupV2ResponseRegistrantContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupV2ResponseRegistrantContactBuilder {
    id: Option<String>,
    name: Option<String>,
...
impl DomainWhoisLookupV2ResponseRegistrantContactBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupV2ResponseRegistrantContact`].
    pub fn build(self) -> Result<DomainWhoisLookupV2ResponseRegistrantContact, BuildError> {
        Ok(DomainWhoisLookupV2ResponseRegistrantContact {
            id: self.id,
            name: self.name,
