...
pub struct WeatherForecastResponseForecastValueAstronomy {
...
impl WeatherForecastResponseForecastValueAstronomy {
    pub fn builder() -> WeatherForecastResponseForecastValueAstronomyBuilder {
        <WeatherForecastResponseForecastValueAstronomyBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct WeatherForecastResponseForecastValueAstronomyBuilder {
...
impl WeatherForecastResponseForecastValueAstronomyBuilder {
    ...
    /// Consumes the builder and constructs a [`WeatherForecastResponseForecastValueAstronomy`].
    /// This method will fail if any of the following fields are not set:
    /// - [`date`](WeatherForecastResponseForecastValueAstronomyBuilder::date)
    /// - [`mid_night`](WeatherForecastResponseForecastValueAstronomyBuilder::mid_night)
    /// - [`night_end`](WeatherForecastResponseForecastValueAstronomyBuilder::night_end)
    /// - [`sunrise`](WeatherForecastResponseForecastValueAstronomyBuilder::sunrise)
    /// - [`solar_noon`](WeatherForecastResponseForecastValueAstronomyBuilder::solar_noon)
    /// - [`sunset`](WeatherForecastResponseForecastValueAstronomyBuilder::sunset)
    /// - [`night_begin`](WeatherForecastResponseForecastValueAstronomyBuilder::night_begin)
    /// - [`day_length`](WeatherForecastResponseForecastValueAstronomyBuilder::day_length)
    /// - [`sun_status`](WeatherForecastResponseForecastValueAstronomyBuilder::sun_status)
    /// - [`moon_phase`](WeatherForecastResponseForecastValueAstronomyBuilder::moon_phase)
    /// - [`moonrise`](WeatherForecastResponseForecastValueAstronomyBuilder::moonrise)
    /// - [`moonset`](WeatherForecastResponseForecastValueAstronomyBuilder::moonset)
    /// - [`moon_status`](WeatherForecastResponseForecastValueAstronomyBuilder::moon_status)
    pub fn build(self) -> Result<WeatherForecastResponseForecastValueAstronomy, BuildError> {
        Ok(WeatherForecastResponseForecastValueAstronomy {
