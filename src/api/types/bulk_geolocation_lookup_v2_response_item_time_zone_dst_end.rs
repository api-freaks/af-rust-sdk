...
pub struct BulkGeolocationLookupV2ResponseItemTimeZoneDstEnd {
...
impl BulkGeolocationLookupV2ResponseItemTimeZoneDstEnd {
    pub fn builder() -> BulkGeolocationLookupV2ResponseItemTimeZoneDstEndBuilder {
        <BulkGeolocationLookupV2ResponseItemTimeZoneDstEndBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupV2ResponseItemTimeZoneDstEndBuilder {
...
impl BulkGeolocationLookupV2ResponseItemTimeZoneDstEndBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkGeolocationLookupV2ResponseItemTimeZoneDstEnd`].
    pub fn build(self) -> Result<BulkGeolocationLookupV2ResponseItemTimeZoneDstEnd, BuildError> {
        Ok(BulkGeolocationLookupV2ResponseItemTimeZoneDstEnd {
