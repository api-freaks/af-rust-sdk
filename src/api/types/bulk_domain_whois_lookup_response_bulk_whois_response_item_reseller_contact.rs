...
pub struct BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContact {
...
impl BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContact {
    pub fn builder() -> BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContactBuilder {
        <BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContactBuilder {
    name: Option<String>,
...
impl BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContactBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContact`].
    pub fn build(
        self,
    ) -> Result<BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContact, BuildError> {
        Ok(
