...
pub struct BulkGeolocationLookupV2ResponseItemSecurity {
...
impl BulkGeolocationLookupV2ResponseItemSecurity {
    pub fn builder() -> BulkGeolocationLookupV2ResponseItemSecurityBuilder {
        <BulkGeolocationLookupV2ResponseItemSecurityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupV2ResponseItemSecurityBuilder {
...
impl BulkGeolocationLookupV2ResponseItemSecurityBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkGeolocationLookupV2ResponseItemSecurity`].
    pub fn build(self) -> Result<BulkGeolocationLookupV2ResponseItemSecurity, BuildError> {
        Ok(BulkGeolocationLookupV2ResponseItemSecurity {
