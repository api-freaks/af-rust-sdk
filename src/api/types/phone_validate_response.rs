...
pub struct PhoneValidateResponse {
    ...
    pub raw_input: Option<PhoneValidateResponseRawInput>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub line_type: Option<PhoneValidateResponseLineType>,
    /// The number represented in four standardized formats. Only returned for valid numbers.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub formats: Option<PhoneValidateResponseFormats>,
...
impl PhoneValidateResponse {
    pub fn builder() -> PhoneValidateResponseBuilder {
        <PhoneValidateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PhoneValidateResponseBuilder {
    raw_input: Option<PhoneValidateResponseRawInput>,
    ...
    line_type: Option<PhoneValidateResponseLineType>,
    formats: Option<PhoneValidateResponseFormats>,
    area_code_length: Option<i64>,
    ndc_length: Option<i64>,
    can_be_internationally_dialled: Option<bool>,
}

impl PhoneValidateResponseBuilder {
    pub fn raw_input(mut self, value: PhoneValidateResponseRawInput) -> Self {
    ...
    pub fn line_type(mut self, value: PhoneValidateResponseLineType) -> Self {
        self.line_type = Some(value);
        self
    }

    pub fn formats(mut self, value: PhoneValidateResponseFormats) -> Self {
    ...
    /// Consumes the builder and constructs a [`PhoneValidateResponse`].
    pub fn build(self) -> Result<PhoneValidateResponse, BuildError> {
        Ok(PhoneValidateResponse {
