...
pub struct DomainWhoisLookupResponseRegistryDataDomainRegistrar {
...
impl DomainWhoisLookupResponseRegistryDataDomainRegistrar {
    pub fn builder() -> DomainWhoisLookupResponseRegistryDataDomainRegistrarBuilder {
        <DomainWhoisLookupResponseRegistryDataDomainRegistrarBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupResponseRegistryDataDomainRegistrarBuilder {
...
impl DomainWhoisLookupResponseRegistryDataDomainRegistrarBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupResponseRegistryDataDomainRegistrar`].
    pub fn build(self) -> Result<DomainWhoisLookupResponseRegistryDataDomainRegistrar, BuildError> {
        Ok(DomainWhoisLookupResponseRegistryDataDomainRegistrar {
