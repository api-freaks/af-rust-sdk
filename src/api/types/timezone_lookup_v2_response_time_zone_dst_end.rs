...
pub struct TimezoneLookupV2ResponseTimeZoneDstEnd {
...
impl TimezoneLookupV2ResponseTimeZoneDstEnd {
    pub fn builder() -> TimezoneLookupV2ResponseTimeZoneDstEndBuilder {
        <TimezoneLookupV2ResponseTimeZoneDstEndBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TimezoneLookupV2ResponseTimeZoneDstEndBuilder {
...
impl TimezoneLookupV2ResponseTimeZoneDstEndBuilder {
    ...
    /// Consumes the builder and constructs a [`TimezoneLookupV2ResponseTimeZoneDstEnd`].
    pub fn build(self) -> Result<TimezoneLookupV2ResponseTimeZoneDstEnd, BuildError> {
        Ok(TimezoneLookupV2ResponseTimeZoneDstEnd {
