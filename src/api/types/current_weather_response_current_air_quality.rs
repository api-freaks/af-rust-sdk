...
impl CurrentWeatherResponseCurrentAirQuality {
    pub fn builder() -> CurrentWeatherResponseCurrentAirQualityBuilder {
        <CurrentWeatherResponseCurrentAirQualityBuilder as Default>::default()
    }
}
...
impl CurrentWeatherResponseCurrentAirQualityBuilder {
    ...
    /// Consumes the builder and constructs a [`CurrentWeatherResponseCurrentAirQuality`].
    /// This method will fail if any of the following fields are not set:
    /// - [`timestamp`](CurrentWeatherResponseCurrentAirQualityBuilder::timestamp)
    /// - [`european_aqi`](CurrentWeatherResponseCurrentAirQualityBuilder::european_aqi)
    /// - [`us_aqi`](CurrentWeatherResponseCurrentAirQualityBuilder::us_aqi)
    /// - [`pm10`](CurrentWeatherResponseCurrentAirQualityBuilder::pm10)
    /// - [`pm25`](CurrentWeatherResponseCurrentAirQualityBuilder::pm25)
    /// - [`carbon_monoxide`](CurrentWeatherResponseCurrentAirQualityBuilder::carbon_monoxide)
    /// - [`nitrogen_dioxide`](CurrentWeatherResponseCurrentAirQualityBuilder::nitrogen_dioxide)
    /// - [`sulphur_dioxide`](CurrentWeatherResponseCurrentAirQualityBuilder::sulphur_dioxide)
    /// - [`ozone`](CurrentWeatherResponseCurrentAirQualityBuilder::ozone)
    /// - [`dust`](CurrentWeatherResponseCurrentAirQualityBuilder::dust)
    /// - [`uv_index`](CurrentWeatherResponseCurrentAirQualityBuilder::uv_index)
    /// - [`aerosol_optical_depth`](CurrentWeatherResponseCurrentAirQualityBuilder::aerosol_optical_depth)
    /// - [`uv_index_clear_sky`](CurrentWeatherResponseCurrentAirQualityBuilder::uv_index_clear_sky)
    pub fn build(self) -> Result<CurrentWeatherResponseCurrentAirQuality, BuildError> {
        Ok(CurrentWeatherResponseCurrentAirQuality {
            timestamp: self
                .timestamp
