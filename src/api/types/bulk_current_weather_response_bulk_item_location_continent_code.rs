...
pub struct BulkCurrentWeatherResponseBulkItemLocationContinentCode {
...
impl BulkCurrentWeatherResponseBulkItemLocationContinentCode {
    pub fn builder() -> BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder {
        <BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder {
...
impl BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkCurrentWeatherResponseBulkItemLocationContinentCode`].
    /// This method will fail if any of the following fields are not set:
    /// - [`continent_code`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::continent_code)
    /// - [`continent_name`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::continent_name)
    /// - [`country_code2`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::country_code2)
    /// - [`country_code3`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::country_code3)
    /// - [`country_name`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::country_name)
    /// - [`country_name_official`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::country_name_official)
    /// - [`state_prov`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::state_prov)
    /// - [`city`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::city)
    /// - [`latitude`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::latitude)
    /// - [`longitude`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::longitude)
    /// - [`timezone`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::timezone)
    /// - [`timezone_abbreviation`](BulkCurrentWeatherResponseBulkItemLocationContinentCodeBuilder::timezone_abbreviation)
    pub fn build(
        self,
    ) -> Result<BulkCurrentWeatherResponseBulkItemLocationContinentCode, BuildError> {
        Ok(BulkCurrentWeatherResponseBulkItemLocationContinentCode {
            continent_code: self
                .continent_code
