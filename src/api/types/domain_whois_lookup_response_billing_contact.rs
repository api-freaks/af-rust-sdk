...
pub struct DomainWhoisLookupResponseBillingContact {
...
impl DomainWhoisLookupResponseBillingContact {
    pub fn builder() -> DomainWhoisLookupResponseBillingContactBuilder {
        <DomainWhoisLookupResponseBillingContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupResponseBillingContactBuilder {
    name: Option<String>,
...
impl DomainWhoisLookupResponseBillingContactBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupResponseBillingContact`].
    pub fn build(self) -> Result<DomainWhoisLookupResponseBillingContact, BuildError> {
        Ok(DomainWhoisLookupResponseBillingContact {
            name: self.name,
