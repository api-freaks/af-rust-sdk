...
pub enum PdfConvertToGifRequestProfile {
    Bw,
    Gray,
    Rgb,
    Rgba,
...
impl Serialize for PdfConvertToGifRequestProfile {
...
impl<'de> Deserialize<'de> for PdfConvertToGifRequestProfile {
...
impl fmt::Display for PdfConvertToGifRequestProfile {
