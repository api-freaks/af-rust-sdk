...
pub struct MarineWeatherResponseLocationCity {
...
impl MarineWeatherResponseLocationCity {
    pub fn builder() -> MarineWeatherResponseLocationCityBuilder {
        <MarineWeatherResponseLocationCityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct MarineWeatherResponseLocationCityBuilder {
...
impl MarineWeatherResponseLocationCityBuilder {
    ...
    /// Consumes the builder and constructs a [`MarineWeatherResponseLocationCity`].
    /// This method will fail if any of the following fields are not set:
    /// - [`location_string`](MarineWeatherResponseLocationCityBuilder::location_string)
    /// - [`country_name`](MarineWeatherResponseLocationCityBuilder::country_name)
    /// - [`state_prov`](MarineWeatherResponseLocationCityBuilder::state_prov)
    /// - [`city`](MarineWeatherResponseLocationCityBuilder::city)
    /// - [`latitude`](MarineWeatherResponseLocationCityBuilder::latitude)
    /// - [`longitude`](MarineWeatherResponseLocationCityBuilder::longitude)
    /// - [`timezone`](MarineWeatherResponseLocationCityBuilder::timezone)
    /// - [`timezone_abbreviation`](MarineWeatherResponseLocationCityBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<MarineWeatherResponseLocationCity, BuildError> {
        Ok(MarineWeatherResponseLocationCity {
