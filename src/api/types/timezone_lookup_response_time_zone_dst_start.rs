...
pub struct TimezoneLookupResponseTimeZoneDstStart {
...
impl TimezoneLookupResponseTimeZoneDstStart {
    pub fn builder() -> TimezoneLookupResponseTimeZoneDstStartBuilder {
        <TimezoneLookupResponseTimeZoneDstStartBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TimezoneLookupResponseTimeZoneDstStartBuilder {
...
impl TimezoneLookupResponseTimeZoneDstStartBuilder {
    ...
    /// Consumes the builder and constructs a [`TimezoneLookupResponseTimeZoneDstStart`].
    pub fn build(self) -> Result<TimezoneLookupResponseTimeZoneDstStart, BuildError> {
        Ok(TimezoneLookupResponseTimeZoneDstStart {
