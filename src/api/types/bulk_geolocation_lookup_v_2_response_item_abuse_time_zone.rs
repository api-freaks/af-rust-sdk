...
pub struct BulkGeolocationLookupV2ResponseItemAbuseTimeZone {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dst_start: Option<BulkGeolocationLookupV2ResponseItemAbuseTimeZoneDstStart>,
    /// DST transition details (used for both the DST start and DST end transitions).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dst_end: Option<BulkGeolocationLookupV2ResponseItemAbuseTimeZoneDstEnd>,
}

impl BulkGeolocationLookupV2ResponseItemAbuseTimeZone {
    pub fn builder() -> BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder {
        <BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder {
    name: Option<String>,
    offset: Option<f64>,
    ...
    dst_start: Option<BulkGeolocationLookupV2ResponseItemAbuseTimeZoneDstStart>,
    dst_end: Option<BulkGeolocationLookupV2ResponseItemAbuseTimeZoneDstEnd>,
}

impl BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder {
    ...
    pub fn dst_start(
        mut self,
        value: BulkGeolocationLookupV2ResponseItemAbuseTimeZoneDstStart,
    ) -> Self {
    ...
    pub fn dst_end(
        mut self,
        value: BulkGeolocationLookupV2ResponseItemAbuseTimeZoneDstEnd,
    ) -> Self {
        self.dst_end = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`BulkGeolocationLookupV2ResponseItemAbuseTimeZone`].
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder::name)
    /// - [`offset`](BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder::offset)
    /// - [`offset_with_dst`](BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder::offset_with_dst)
    /// - [`current_time`](BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder::current_time)
    /// - [`current_time_unix`](BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder::current_time_unix)
    /// - [`is_dst`](BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder::is_dst)
    /// - [`dst_savings`](BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder::dst_savings)
    /// - [`dst_exists`](BulkGeolocationLookupV2ResponseItemAbuseTimeZoneBuilder::dst_exists)
    pub fn build(self) -> Result<BulkGeolocationLookupV2ResponseItemAbuseTimeZone, BuildError> {
        Ok(BulkGeolocationLookupV2ResponseItemAbuseTimeZone {
