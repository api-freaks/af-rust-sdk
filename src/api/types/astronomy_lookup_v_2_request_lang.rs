...
pub enum AstronomyLookupV2RequestLang {
    En,
    De,
    Ru,
    Ja,
...
impl Serialize for AstronomyLookupV2RequestLang {
...
impl<'de> Deserialize<'de> for AstronomyLookupV2RequestLang {
...
impl fmt::Display for AstronomyLookupV2RequestLang {
