...
pub struct AirQualityResponseLocationCity {
...
impl AirQualityResponseLocationCity {
    pub fn builder() -> AirQualityResponseLocationCityBuilder {
        <AirQualityResponseLocationCityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AirQualityResponseLocationCityBuilder {
...
impl AirQualityResponseLocationCityBuilder {
    ...
    /// Consumes the builder and constructs a [`AirQualityResponseLocationCity`].
    /// This method will fail if any of the following fields are not set:
    /// - [`location_string`](AirQualityResponseLocationCityBuilder::location_string)
    /// - [`country_name`](AirQualityResponseLocationCityBuilder::country_name)
    /// - [`state_prov`](AirQualityResponseLocationCityBuilder::state_prov)
    /// - [`city`](AirQualityResponseLocationCityBuilder::city)
    /// - [`latitude`](AirQualityResponseLocationCityBuilder::latitude)
    /// - [`longitude`](AirQualityResponseLocationCityBuilder::longitude)
    /// - [`timezone`](AirQualityResponseLocationCityBuilder::timezone)
    /// - [`timezone_abbreviation`](AirQualityResponseLocationCityBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<AirQualityResponseLocationCity, BuildError> {
        Ok(AirQualityResponseLocationCity {
