...
pub struct GeolocationLookupV2ResponseNetworkAsn {
    /// The AS number
...
impl GeolocationLookupV2ResponseNetworkAsn {
    pub fn builder() -> GeolocationLookupV2ResponseNetworkAsnBuilder {
        <GeolocationLookupV2ResponseNetworkAsnBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GeolocationLookupV2ResponseNetworkAsnBuilder {
...
impl GeolocationLookupV2ResponseNetworkAsnBuilder {
    ...
    /// Consumes the builder and constructs a [`GeolocationLookupV2ResponseNetworkAsn`].
    pub fn build(self) -> Result<GeolocationLookupV2ResponseNetworkAsn, BuildError> {
        Ok(GeolocationLookupV2ResponseNetworkAsn {
