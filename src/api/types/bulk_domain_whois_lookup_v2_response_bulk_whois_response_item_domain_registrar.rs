...
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemDomainRegistrar {
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemDomainRegistrar {
    pub fn builder() -> BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemDomainRegistrarBuilder {
        <BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemDomainRegistrarBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemDomainRegistrarBuilder {
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemDomainRegistrarBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemDomainRegistrar`].
    pub fn build(
        self,
    ) -> Result<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemDomainRegistrar, BuildError>
    {
        Ok(
            BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemDomainRegistrar {
