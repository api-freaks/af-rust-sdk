...
pub enum BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactDomainRegistered {
    Yes,
    No,
    Restricted,
...
impl Serialize
    for BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactDomainRegistered
{
