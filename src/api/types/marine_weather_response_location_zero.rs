...
pub struct MarineWeatherResponseLocationZero {
...
impl MarineWeatherResponseLocationZero {
    pub fn builder() -> MarineWeatherResponseLocationZeroBuilder {
        <MarineWeatherResponseLocationZeroBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct MarineWeatherResponseLocationZeroBuilder {
    latitude: Option<f64>,
...
impl MarineWeatherResponseLocationZeroBuilder {
    ...
    /// Consumes the builder and constructs a [`MarineWeatherResponseLocationZero`].
    /// This method will fail if any of the following fields are not set:
    /// - [`latitude`](MarineWeatherResponseLocationZeroBuilder::latitude)
    /// - [`longitude`](MarineWeatherResponseLocationZeroBuilder::longitude)
    /// - [`country_name`](MarineWeatherResponseLocationZeroBuilder::country_name)
    /// - [`state_prov`](MarineWeatherResponseLocationZeroBuilder::state_prov)
    /// - [`city`](MarineWeatherResponseLocationZeroBuilder::city)
    /// - [`timezone`](MarineWeatherResponseLocationZeroBuilder::timezone)
    /// - [`timezone_abbreviation`](MarineWeatherResponseLocationZeroBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<MarineWeatherResponseLocationZero, BuildError> {
        Ok(MarineWeatherResponseLocationZero {
            latitude: self
                .latitude
