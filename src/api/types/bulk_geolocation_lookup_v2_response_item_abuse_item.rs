...
pub struct BulkGeolocationLookupV2ResponseItemAbuseItem {
...
impl BulkGeolocationLookupV2ResponseItemAbuseItem {
    pub fn builder() -> BulkGeolocationLookupV2ResponseItemAbuseItemBuilder {
        <BulkGeolocationLookupV2ResponseItemAbuseItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupV2ResponseItemAbuseItemBuilder {
    route: Option<String>,
...
impl BulkGeolocationLookupV2ResponseItemAbuseItemBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkGeolocationLookupV2ResponseItemAbuseItem`].
    pub fn build(self) -> Result<BulkGeolocationLookupV2ResponseItemAbuseItem, BuildError> {
        Ok(BulkGeolocationLookupV2ResponseItemAbuseItem {
            route: self.route,
