...
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryData {
    ...
    pub domain_registered:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistered>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub domain_registrar:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrar>,
}

impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryData {
    pub fn builder() -> BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataBuilder {
        <BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataBuilder as Default>::default(
        )
    }
}
...
#[non_exhaustive]
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataBuilder {
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataBuilder {
    ...
    pub fn domain_registered(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistered,
    ) -> Self {
    ...
    pub fn domain_registrar(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryDataDomainRegistrar,
    ) -> Self {
        self.domain_registrar = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryData`].
    pub fn build(
        self,
    ) -> Result<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryData, BuildError> {
        Ok(
            BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemRegistryData {
