...
pub struct TimezoneLookupResponseTimeZoneDstEnd {
...
impl TimezoneLookupResponseTimeZoneDstEnd {
    pub fn builder() -> TimezoneLookupResponseTimeZoneDstEndBuilder {
        <TimezoneLookupResponseTimeZoneDstEndBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TimezoneLookupResponseTimeZoneDstEndBuilder {
...
impl TimezoneLookupResponseTimeZoneDstEndBuilder {
    ...
    /// Consumes the builder and constructs a [`TimezoneLookupResponseTimeZoneDstEnd`].
    pub fn build(self) -> Result<TimezoneLookupResponseTimeZoneDstEnd, BuildError> {
        Ok(TimezoneLookupResponseTimeZoneDstEnd {
