...
pub struct DomainWhoisLookupV2ResponseTechnicalContact {
...
impl DomainWhoisLookupV2ResponseTechnicalContact {
    pub fn builder() -> DomainWhoisLookupV2ResponseTechnicalContactBuilder {
        <DomainWhoisLookupV2ResponseTechnicalContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupV2ResponseTechnicalContactBuilder {
    name: Option<String>,
...
impl DomainWhoisLookupV2ResponseTechnicalContactBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupV2ResponseTechnicalContact`].
    pub fn build(self) -> Result<DomainWhoisLookupV2ResponseTechnicalContact, BuildError> {
        Ok(DomainWhoisLookupV2ResponseTechnicalContact {
            name: self.name,
