...
pub struct GeolocationLookupV2ResponseTimeZoneDstEnd {
...
impl GeolocationLookupV2ResponseTimeZoneDstEnd {
    pub fn builder() -> GeolocationLookupV2ResponseTimeZoneDstEndBuilder {
        <GeolocationLookupV2ResponseTimeZoneDstEndBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GeolocationLookupV2ResponseTimeZoneDstEndBuilder {
...
impl GeolocationLookupV2ResponseTimeZoneDstEndBuilder {
    ...
    /// Consumes the builder and constructs a [`GeolocationLookupV2ResponseTimeZoneDstEnd`].
    pub fn build(self) -> Result<GeolocationLookupV2ResponseTimeZoneDstEnd, BuildError> {
        Ok(GeolocationLookupV2ResponseTimeZoneDstEnd {
