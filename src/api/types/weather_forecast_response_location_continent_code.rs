...
pub struct WeatherForecastResponseLocationContinentCode {
...
impl WeatherForecastResponseLocationContinentCode {
    pub fn builder() -> WeatherForecastResponseLocationContinentCodeBuilder {
        <WeatherForecastResponseLocationContinentCodeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct WeatherForecastResponseLocationContinentCodeBuilder {
...
impl WeatherForecastResponseLocationContinentCodeBuilder {
    ...
    /// Consumes the builder and constructs a [`WeatherForecastResponseLocationContinentCode`].
    /// This method will fail if any of the following fields are not set:
    /// - [`continent_code`](WeatherForecastResponseLocationContinentCodeBuilder::continent_code)
    /// - [`continent_name`](WeatherForecastResponseLocationContinentCodeBuilder::continent_name)
    /// - [`country_code2`](WeatherForecastResponseLocationContinentCodeBuilder::country_code2)
    /// - [`country_code3`](WeatherForecastResponseLocationContinentCodeBuilder::country_code3)
    /// - [`country_name`](WeatherForecastResponseLocationContinentCodeBuilder::country_name)
    /// - [`country_name_official`](WeatherForecastResponseLocationContinentCodeBuilder::country_name_official)
    /// - [`state_prov`](WeatherForecastResponseLocationContinentCodeBuilder::state_prov)
    /// - [`city`](WeatherForecastResponseLocationContinentCodeBuilder::city)
    /// - [`latitude`](WeatherForecastResponseLocationContinentCodeBuilder::latitude)
    /// - [`longitude`](WeatherForecastResponseLocationContinentCodeBuilder::longitude)
    /// - [`timezone`](WeatherForecastResponseLocationContinentCodeBuilder::timezone)
    /// - [`timezone_abbreviation`](WeatherForecastResponseLocationContinentCodeBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<WeatherForecastResponseLocationContinentCode, BuildError> {
        Ok(WeatherForecastResponseLocationContinentCode {
            continent_code: self
                .continent_code
