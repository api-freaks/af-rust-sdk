...
pub struct PdfRemovePagesRequest {
    ...
    pub api_key: String,
    #[serde(skip_serializing)]
    pub format: Option<PdfRemovePagesRequestFormat>,
    #[serde(skip_serializing)]
...
impl PdfRemovePagesRequest {
    pub fn builder() -> PdfRemovePagesRequestBuilder {
        <PdfRemovePagesRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PdfRemovePagesRequestBuilder {
    file: Option<Vec<u8>>,
    api_key: Option<String>,
    format: Option<PdfRemovePagesRequestFormat>,
...
impl PdfRemovePagesRequestBuilder {
    ...
    pub fn format(mut self, value: PdfRemovePagesRequestFormat) -> Self {
    ...
    /// Consumes the builder and constructs a [`PdfRemovePagesRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`api_key`](PdfRemovePagesRequestBuilder::api_key)
    /// - [`pages`](PdfRemovePagesRequestBuilder::pages)
    pub fn build(self) -> Result<PdfRemovePagesRequest, BuildError> {
        Ok(PdfRemovePagesRequest {
            file: self.file,
            api_key: self
                .api_key
