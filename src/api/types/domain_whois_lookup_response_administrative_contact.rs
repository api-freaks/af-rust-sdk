...
pub struct DomainWhoisLookupResponseAdministrativeContact {
...
impl DomainWhoisLookupResponseAdministrativeContact {
    pub fn builder() -> DomainWhoisLookupResponseAdministrativeContactBuilder {
        <DomainWhoisLookupResponseAdministrativeContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupResponseAdministrativeContactBuilder {
    name: Option<String>,
...
impl DomainWhoisLookupResponseAdministrativeContactBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupResponseAdministrativeContact`].
    pub fn build(self) -> Result<DomainWhoisLookupResponseAdministrativeContact, BuildError> {
        Ok(DomainWhoisLookupResponseAdministrativeContact {
            name: self.name,
