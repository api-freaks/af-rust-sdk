...
pub enum BulkPhoneValidateResponseItemLineType {
    Mobile,
    FixedLine,
    FixedLineOrMobile,
    Voip,
...
impl Serialize for BulkPhoneValidateResponseItemLineType {
...
impl<'de> Deserialize<'de> for BulkPhoneValidateResponseItemLineType {
...
impl fmt::Display for BulkPhoneValidateResponseItemLineType {
