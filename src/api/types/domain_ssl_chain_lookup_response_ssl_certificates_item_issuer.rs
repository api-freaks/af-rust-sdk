...
pub struct DomainSslChainLookupResponseSslCertificatesItemIssuer {
...
impl DomainSslChainLookupResponseSslCertificatesItemIssuer {
    pub fn builder() -> DomainSslChainLookupResponseSslCertificatesItemIssuerBuilder {
        <DomainSslChainLookupResponseSslCertificatesItemIssuerBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainSslChainLookupResponseSslCertificatesItemIssuerBuilder {
...
impl DomainSslChainLookupResponseSslCertificatesItemIssuerBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainSslChainLookupResponseSslCertificatesItemIssuer`].
    /// This method will fail if any of the following fields are not set:
    /// - [`common_name`](DomainSslChainLookupResponseSslCertificatesItemIssuerBuilder::common_name)
    /// - [`organization`](DomainSslChainLookupResponseSslCertificatesItemIssuerBuilder::organization)
    /// - [`country`](DomainSslChainLookupResponseSslCertificatesItemIssuerBuilder::country)
    pub fn build(
        self,
    ) -> Result<DomainSslChainLookupResponseSslCertificatesItemIssuer, BuildError> {
        Ok(DomainSslChainLookupResponseSslCertificatesItemIssuer {
            common_name: self
                .common_name
