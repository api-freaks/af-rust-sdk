...
pub struct DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryData {
    ...
    pub domain_registered:
        Option<DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryDataDomainRegistered>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub domain_registrar:
        Option<DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryDataDomainRegistrar>,
}

impl DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryData {
    pub fn builder() -> DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryDataBuilder {
        <DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryDataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryDataBuilder {
...
impl DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryDataBuilder {
    ...
    pub fn domain_registered(
        mut self,
        value: DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryDataDomainRegistered,
    ) -> Self {
    ...
    pub fn domain_registrar(
        mut self,
        value: DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryDataDomainRegistrar,
    ) -> Self {
        self.domain_registrar = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryData`].
    pub fn build(
        self,
    ) -> Result<DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryData, BuildError> {
        Ok(
