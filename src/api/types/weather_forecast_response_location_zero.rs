...
pub struct WeatherForecastResponseLocationZero {
...
impl WeatherForecastResponseLocationZero {
    pub fn builder() -> WeatherForecastResponseLocationZeroBuilder {
        <WeatherForecastResponseLocationZeroBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct WeatherForecastResponseLocationZeroBuilder {
    latitude: Option<f64>,
...
impl WeatherForecastResponseLocationZeroBuilder {
    ...
    /// Consumes the builder and constructs a [`WeatherForecastResponseLocationZero`].
    /// This method will fail if any of the following fields are not set:
    /// - [`latitude`](WeatherForecastResponseLocationZeroBuilder::latitude)
    /// - [`longitude`](WeatherForecastResponseLocationZeroBuilder::longitude)
    /// - [`country_name`](WeatherForecastResponseLocationZeroBuilder::country_name)
    /// - [`state_prov`](WeatherForecastResponseLocationZeroBuilder::state_prov)
    /// - [`city`](WeatherForecastResponseLocationZeroBuilder::city)
    /// - [`timezone`](WeatherForecastResponseLocationZeroBuilder::timezone)
    /// - [`timezone_abbreviation`](WeatherForecastResponseLocationZeroBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<WeatherForecastResponseLocationZero, BuildError> {
        Ok(WeatherForecastResponseLocationZero {
            latitude: self
                .latitude
