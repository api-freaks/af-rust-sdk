...
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContact {
    ...
    pub domain_registrar:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactDomainRegistrar>,
    ...
    pub reseller_contact:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactResellerContact>,
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub registrant_contact:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistrantContact>,
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub administrative_contact: Option<
        BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAdministrativeContact,
    >,
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub technical_contact:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactTechnicalContact>,
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_contact:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBillingContact>,
    /// Registrar's abuse-reporting contact.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub abuse_contact:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAbuseContact>,
    /// Domain eligibility information (populated for TLDs with registrant eligibility requirements, e.g. .eu).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub eligibility_info:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactEligibilityInfo>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub registry_data:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistryData>,
}

impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContact {
    pub fn builder() -> BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBuilder {
        <BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBuilder {
    status: Option<bool>,
    domain_name: Option<String>,
    query_time: Option<String>,
    whois_server: Option<String>,
    domain_registered:
        Option<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactDomainRegistered>,
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBuilder {
    ...
    pub fn domain_registered(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactDomainRegistered,
    ) -> Self {
    ...
    pub fn domain_registrar(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactDomainRegistrar,
    ) -> Self {
    ...
    pub fn reseller_contact(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactResellerContact,
    ) -> Self {
    ...
    pub fn registrant_contact(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistrantContact,
    ) -> Self {
    ...
    pub fn administrative_contact(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAdministrativeContact,
    ) -> Self {
    ...
    pub fn technical_contact(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactTechnicalContact,
    ) -> Self {
    ...
    pub fn billing_contact(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBillingContact,
    ) -> Self {
        self.billing_contact = Some(value);
        self
    }

    pub fn abuse_contact(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAbuseContact,
    ) -> Self {
        self.abuse_contact = Some(value);
        self
    }

    pub fn eligibility_info(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactEligibilityInfo,
    ) -> Self {
    ...
    pub fn registry_data(
        mut self,
        value: BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistryData,
    ) -> Self {
        self.registry_data = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContact`].
    ...
    pub fn build(
        self,
    ) -> Result<BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContact, BuildError> {
        Ok(
