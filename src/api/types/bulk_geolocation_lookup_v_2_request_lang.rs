...
pub enum BulkGeolocationLookupV2RequestLang {
    En,
    De,
    Ru,
    Ja,
...
impl Serialize for BulkGeolocationLookupV2RequestLang {
...
impl<'de> Deserialize<'de> for BulkGeolocationLookupV2RequestLang {
...
impl fmt::Display for BulkGeolocationLookupV2RequestLang {
