...
pub struct WeatherTimeSeriesResponseHistoricalValueAstronomy {
...
impl WeatherTimeSeriesResponseHistoricalValueAstronomy {
    pub fn builder() -> WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder {
        <WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder {
...
impl WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder {
    ...
    /// Consumes the builder and constructs a [`WeatherTimeSeriesResponseHistoricalValueAstronomy`].
    /// This method will fail if any of the following fields are not set:
    /// - [`date`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::date)
    /// - [`mid_night`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::mid_night)
    /// - [`night_end`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::night_end)
    /// - [`sunrise`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::sunrise)
    /// - [`solar_noon`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::solar_noon)
    /// - [`sunset`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::sunset)
    /// - [`night_begin`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::night_begin)
    /// - [`day_length`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::day_length)
    /// - [`sun_status`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::sun_status)
    /// - [`moon_phase`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::moon_phase)
    /// - [`moonrise`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::moonrise)
    /// - [`moonset`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::moonset)
    /// - [`moon_status`](WeatherTimeSeriesResponseHistoricalValueAstronomyBuilder::moon_status)
    pub fn build(self) -> Result<WeatherTimeSeriesResponseHistoricalValueAstronomy, BuildError> {
        Ok(WeatherTimeSeriesResponseHistoricalValueAstronomy {
