...
pub struct BulkGeolocationLookupV2ResponseItemLocation {
...
impl BulkGeolocationLookupV2ResponseItemLocation {
    pub fn builder() -> BulkGeolocationLookupV2ResponseItemLocationBuilder {
        <BulkGeolocationLookupV2ResponseItemLocationBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupV2ResponseItemLocationBuilder {
...
impl BulkGeolocationLookupV2ResponseItemLocationBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkGeolocationLookupV2ResponseItemLocation`].
    pub fn build(self) -> Result<BulkGeolocationLookupV2ResponseItemLocation, BuildError> {
        Ok(BulkGeolocationLookupV2ResponseItemLocation {
