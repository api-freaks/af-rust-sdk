...
pub struct CurrentWeatherResponseCurrentAstronomy {
...
impl CurrentWeatherResponseCurrentAstronomy {
    pub fn builder() -> CurrentWeatherResponseCurrentAstronomyBuilder {
        <CurrentWeatherResponseCurrentAstronomyBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CurrentWeatherResponseCurrentAstronomyBuilder {
...
impl CurrentWeatherResponseCurrentAstronomyBuilder {
    ...
    /// Consumes the builder and constructs a [`CurrentWeatherResponseCurrentAstronomy`].
    /// This method will fail if any of the following fields are not set:
    /// - [`date`](CurrentWeatherResponseCurrentAstronomyBuilder::date)
    /// - [`mid_night`](CurrentWeatherResponseCurrentAstronomyBuilder::mid_night)
    /// - [`night_end`](CurrentWeatherResponseCurrentAstronomyBuilder::night_end)
    /// - [`sunrise`](CurrentWeatherResponseCurrentAstronomyBuilder::sunrise)
    /// - [`solar_noon`](CurrentWeatherResponseCurrentAstronomyBuilder::solar_noon)
    /// - [`sunset`](CurrentWeatherResponseCurrentAstronomyBuilder::sunset)
    /// - [`night_begin`](CurrentWeatherResponseCurrentAstronomyBuilder::night_begin)
    /// - [`day_length`](CurrentWeatherResponseCurrentAstronomyBuilder::day_length)
    /// - [`sun_status`](CurrentWeatherResponseCurrentAstronomyBuilder::sun_status)
    /// - [`moon_phase`](CurrentWeatherResponseCurrentAstronomyBuilder::moon_phase)
    /// - [`moonrise`](CurrentWeatherResponseCurrentAstronomyBuilder::moonrise)
    /// - [`moonset`](CurrentWeatherResponseCurrentAstronomyBuilder::moonset)
    /// - [`moon_status`](CurrentWeatherResponseCurrentAstronomyBuilder::moon_status)
    pub fn build(self) -> Result<CurrentWeatherResponseCurrentAstronomy, BuildError> {
        Ok(CurrentWeatherResponseCurrentAstronomy {
