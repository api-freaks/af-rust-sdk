...
pub struct BulkGeolocationLookupV2ResponseItemNetworkAsn {
    /// The AS number
...
impl BulkGeolocationLookupV2ResponseItemNetworkAsn {
    pub fn builder() -> BulkGeolocationLookupV2ResponseItemNetworkAsnBuilder {
        <BulkGeolocationLookupV2ResponseItemNetworkAsnBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupV2ResponseItemNetworkAsnBuilder {
...
impl BulkGeolocationLookupV2ResponseItemNetworkAsnBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkGeolocationLookupV2ResponseItemNetworkAsn`].
    pub fn build(self) -> Result<BulkGeolocationLookupV2ResponseItemNetworkAsn, BuildError> {
        Ok(BulkGeolocationLookupV2ResponseItemNetworkAsn {
