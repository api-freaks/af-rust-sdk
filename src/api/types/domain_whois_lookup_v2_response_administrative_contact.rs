...
pub struct DomainWhoisLookupV2ResponseAdministrativeContact {
...
impl DomainWhoisLookupV2ResponseAdministrativeContact {
    pub fn builder() -> DomainWhoisLookupV2ResponseAdministrativeContactBuilder {
        <DomainWhoisLookupV2ResponseAdministrativeContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupV2ResponseAdministrativeContactBuilder {
    name: Option<String>,
...
impl DomainWhoisLookupV2ResponseAdministrativeContactBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupV2ResponseAdministrativeContact`].
    pub fn build(self) -> Result<DomainWhoisLookupV2ResponseAdministrativeContact, BuildError> {
        Ok(DomainWhoisLookupV2ResponseAdministrativeContact {
            name: self.name,
