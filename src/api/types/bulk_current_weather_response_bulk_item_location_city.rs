...
pub struct BulkCurrentWeatherResponseBulkItemLocationCity {
...
impl BulkCurrentWeatherResponseBulkItemLocationCity {
    pub fn builder() -> BulkCurrentWeatherResponseBulkItemLocationCityBuilder {
        <BulkCurrentWeatherResponseBulkItemLocationCityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkCurrentWeatherResponseBulkItemLocationCityBuilder {
...
impl BulkCurrentWeatherResponseBulkItemLocationCityBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkCurrentWeatherResponseBulkItemLocationCity`].
    /// This method will fail if any of the following fields are not set:
    /// - [`location_string`](BulkCurrentWeatherResponseBulkItemLocationCityBuilder::location_string)
    /// - [`country_name`](BulkCurrentWeatherResponseBulkItemLocationCityBuilder::country_name)
    /// - [`state_prov`](BulkCurrentWeatherResponseBulkItemLocationCityBuilder::state_prov)
    /// - [`city`](BulkCurrentWeatherResponseBulkItemLocationCityBuilder::city)
    /// - [`latitude`](BulkCurrentWeatherResponseBulkItemLocationCityBuilder::latitude)
    /// - [`longitude`](BulkCurrentWeatherResponseBulkItemLocationCityBuilder::longitude)
    /// - [`timezone`](BulkCurrentWeatherResponseBulkItemLocationCityBuilder::timezone)
    /// - [`timezone_abbreviation`](BulkCurrentWeatherResponseBulkItemLocationCityBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<BulkCurrentWeatherResponseBulkItemLocationCity, BuildError> {
        Ok(BulkCurrentWeatherResponseBulkItemLocationCity {
