...
pub struct DomainWhoisLookupResponseTechnicalContact {
...
impl DomainWhoisLookupResponseTechnicalContact {
    pub fn builder() -> DomainWhoisLookupResponseTechnicalContactBuilder {
        <DomainWhoisLookupResponseTechnicalContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupResponseTechnicalContactBuilder {
    name: Option<String>,
...
impl DomainWhoisLookupResponseTechnicalContactBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupResponseTechnicalContact`].
    pub fn build(self) -> Result<DomainWhoisLookupResponseTechnicalContact, BuildError> {
        Ok(DomainWhoisLookupResponseTechnicalContact {
            name: self.name,
