...
pub struct FloodForecastResponseLocationContinentCode {
...
impl FloodForecastResponseLocationContinentCode {
    pub fn builder() -> FloodForecastResponseLocationContinentCodeBuilder {
        <FloodForecastResponseLocationContinentCodeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct FloodForecastResponseLocationContinentCodeBuilder {
...
impl FloodForecastResponseLocationContinentCodeBuilder {
    ...
    /// Consumes the builder and constructs a [`FloodForecastResponseLocationContinentCode`].
    /// This method will fail if any of the following fields are not set:
    /// - [`continent_code`](FloodForecastResponseLocationContinentCodeBuilder::continent_code)
    /// - [`continent_name`](FloodForecastResponseLocationContinentCodeBuilder::continent_name)
    /// - [`country_code2`](FloodForecastResponseLocationContinentCodeBuilder::country_code2)
    /// - [`country_code3`](FloodForecastResponseLocationContinentCodeBuilder::country_code3)
    /// - [`country_name`](FloodForecastResponseLocationContinentCodeBuilder::country_name)
    /// - [`country_name_official`](FloodForecastResponseLocationContinentCodeBuilder::country_name_official)
    /// - [`state_prov`](FloodForecastResponseLocationContinentCodeBuilder::state_prov)
    /// - [`city`](FloodForecastResponseLocationContinentCodeBuilder::city)
    /// - [`latitude`](FloodForecastResponseLocationContinentCodeBuilder::latitude)
    /// - [`longitude`](FloodForecastResponseLocationContinentCodeBuilder::longitude)
    /// - [`timezone`](FloodForecastResponseLocationContinentCodeBuilder::timezone)
    /// - [`timezone_abbreviation`](FloodForecastResponseLocationContinentCodeBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<FloodForecastResponseLocationContinentCode, BuildError> {
        Ok(FloodForecastResponseLocationContinentCode {
            continent_code: self
                .continent_code
