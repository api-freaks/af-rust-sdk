...
pub struct BulkGeolocationLookupResponseItemAbuseItem {
...
impl BulkGeolocationLookupResponseItemAbuseItem {
    pub fn builder() -> BulkGeolocationLookupResponseItemAbuseItemBuilder {
        <BulkGeolocationLookupResponseItemAbuseItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkGeolocationLookupResponseItemAbuseItemBuilder {
    route: Option<String>,
...
impl BulkGeolocationLookupResponseItemAbuseItemBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkGeolocationLookupResponseItemAbuseItem`].
    pub fn build(self) -> Result<BulkGeolocationLookupResponseItemAbuseItem, BuildError> {
        Ok(BulkGeolocationLookupResponseItemAbuseItem {
            route: self.route,
