...
impl WeatherForecastResponseLocationCity {
    pub fn builder() -> WeatherForecastResponseLocationCityBuilder {
        <WeatherForecastResponseLocationCityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct WeatherForecastResponseLocationCityBuilder {
...
impl WeatherForecastResponseLocationCityBuilder {
    ...
    /// Consumes the builder and constructs a [`WeatherForecastResponseLocationCity`].
    /// This method will fail if any of the following fields are not set:
    /// - [`location_string`](WeatherForecastResponseLocationCityBuilder::location_string)
    /// - [`country_name`](WeatherForecastResponseLocationCityBuilder::country_name)
    /// - [`state_prov`](WeatherForecastResponseLocationCityBuilder::state_prov)
    /// - [`city`](WeatherForecastResponseLocationCityBuilder::city)
    /// - [`latitude`](WeatherForecastResponseLocationCityBuilder::latitude)
    /// - [`longitude`](WeatherForecastResponseLocationCityBuilder::longitude)
    /// - [`timezone`](WeatherForecastResponseLocationCityBuilder::timezone)
    /// - [`timezone_abbreviation`](WeatherForecastResponseLocationCityBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<WeatherForecastResponseLocationCity, BuildError> {
        Ok(WeatherForecastResponseLocationCity {
