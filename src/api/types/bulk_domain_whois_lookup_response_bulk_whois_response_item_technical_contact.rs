...
pub struct BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContact {
...
impl BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContact {
    pub fn builder() -> BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContactBuilder {
        <BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContactBuilder {
    name: Option<String>,
...
impl BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContactBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContact`].
    pub fn build(
        self,
    ) -> Result<BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContact, BuildError>
    {
        Ok(
