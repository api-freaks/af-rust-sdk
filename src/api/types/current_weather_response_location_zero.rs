...
pub struct CurrentWeatherResponseLocationZero {
...
impl CurrentWeatherResponseLocationZero {
    pub fn builder() -> CurrentWeatherResponseLocationZeroBuilder {
        <CurrentWeatherResponseLocationZeroBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CurrentWeatherResponseLocationZeroBuilder {
    latitude: Option<f64>,
...
impl CurrentWeatherResponseLocationZeroBuilder {
    ...
    /// Consumes the builder and constructs a [`CurrentWeatherResponseLocationZero`].
    /// This method will fail if any of the following fields are not set:
    /// - [`latitude`](CurrentWeatherResponseLocationZeroBuilder::latitude)
    /// - [`longitude`](CurrentWeatherResponseLocationZeroBuilder::longitude)
    /// - [`country_name`](CurrentWeatherResponseLocationZeroBuilder::country_name)
    /// - [`state_prov`](CurrentWeatherResponseLocationZeroBuilder::state_prov)
    /// - [`city`](CurrentWeatherResponseLocationZeroBuilder::city)
    /// - [`timezone`](CurrentWeatherResponseLocationZeroBuilder::timezone)
    /// - [`timezone_abbreviation`](CurrentWeatherResponseLocationZeroBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<CurrentWeatherResponseLocationZero, BuildError> {
        Ok(CurrentWeatherResponseLocationZero {
            latitude: self
                .latitude
