...
pub struct GeolocationLookupResponseTimeZoneDstEnd {
...
impl GeolocationLookupResponseTimeZoneDstEnd {
    pub fn builder() -> GeolocationLookupResponseTimeZoneDstEndBuilder {
        <GeolocationLookupResponseTimeZoneDstEndBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GeolocationLookupResponseTimeZoneDstEndBuilder {
...
impl GeolocationLookupResponseTimeZoneDstEndBuilder {
    ...
    /// Consumes the builder and constructs a [`GeolocationLookupResponseTimeZoneDstEnd`].
    pub fn build(self) -> Result<GeolocationLookupResponseTimeZoneDstEnd, BuildError> {
        Ok(GeolocationLookupResponseTimeZoneDstEnd {
