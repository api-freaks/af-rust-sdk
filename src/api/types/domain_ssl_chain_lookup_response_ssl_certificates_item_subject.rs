...
pub struct DomainSslChainLookupResponseSslCertificatesItemSubject {
...
impl DomainSslChainLookupResponseSslCertificatesItemSubject {
    pub fn builder() -> DomainSslChainLookupResponseSslCertificatesItemSubjectBuilder {
        <DomainSslChainLookupResponseSslCertificatesItemSubjectBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainSslChainLookupResponseSslCertificatesItemSubjectBuilder {
...
impl DomainSslChainLookupResponseSslCertificatesItemSubjectBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainSslChainLookupResponseSslCertificatesItemSubject`].
    /// This method will fail if any of the following fields are not set:
    /// - [`common_name`](DomainSslChainLookupResponseSslCertificatesItemSubjectBuilder::common_name)
    pub fn build(
        self,
    ) -> Result<DomainSslChainLookupResponseSslCertificatesItemSubject, BuildError> {
        Ok(DomainSslChainLookupResponseSslCertificatesItemSubject {
            common_name: self
                .common_name
