...
pub struct BulkDomainDnsLookupResponseBulkDnsInfoItemDnsTypes {
    #[serde(rename = "A")]
...
impl BulkDomainDnsLookupResponseBulkDnsInfoItemDnsTypes {
    pub fn builder() -> BulkDomainDnsLookupResponseBulkDnsInfoItemDnsTypesBuilder {
        <BulkDomainDnsLookupResponseBulkDnsInfoItemDnsTypesBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainDnsLookupResponseBulkDnsInfoItemDnsTypesBuilder {
    a: Option<f64>,
    aaaa: Option<f64>,
    cname: Option<f64>,
    mx: Option<f64>,
