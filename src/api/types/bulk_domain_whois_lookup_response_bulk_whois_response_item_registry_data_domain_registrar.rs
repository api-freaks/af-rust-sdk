...
pub struct BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistrar {
...
impl BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistrar {
    pub fn builder(
    ) -> BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistrarBuilder {
        <BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistrarBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistrarBuilder {
...
impl BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistrarBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistrar`].
    pub fn build(
        self,
    ) -> Result<
