...
pub enum ZipcodeDistanceRequestUnit {
    M,
    Km,
    Mi,
    Ft,
...
impl Serialize for ZipcodeDistanceRequestUnit {
...
impl<'de> Deserialize<'de> for ZipcodeDistanceRequestUnit {
...
impl fmt::Display for ZipcodeDistanceRequestUnit {
