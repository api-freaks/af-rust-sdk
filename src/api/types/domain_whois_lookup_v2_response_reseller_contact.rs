...
pub struct DomainWhoisLookupV2ResponseResellerContact {
...
impl DomainWhoisLookupV2ResponseResellerContact {
    pub fn builder() -> DomainWhoisLookupV2ResponseResellerContactBuilder {
        <DomainWhoisLookupV2ResponseResellerContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupV2ResponseResellerContactBuilder {
    name: Option<String>,
...
impl DomainWhoisLookupV2ResponseResellerContactBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupV2ResponseResellerContact`].
    pub fn build(self) -> Result<DomainWhoisLookupV2ResponseResellerContact, BuildError> {
        Ok(DomainWhoisLookupV2ResponseResellerContact {
            name: self.name,
