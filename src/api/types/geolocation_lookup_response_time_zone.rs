...
pub struct GeolocationLookupResponseTimeZone {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dst_start: Option<GeolocationLookupResponseTimeZoneDstStart>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dst_end: Option<GeolocationLookupResponseTimeZoneDstEnd>,
}

impl GeolocationLookupResponseTimeZone {
    pub fn builder() -> GeolocationLookupResponseTimeZoneBuilder {
        <GeolocationLookupResponseTimeZoneBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GeolocationLookupResponseTimeZoneBuilder {
    name: Option<String>,
    offset: Option<f64>,
    ...
    dst_start: Option<GeolocationLookupResponseTimeZoneDstStart>,
    dst_end: Option<GeolocationLookupResponseTimeZoneDstEnd>,
}

impl GeolocationLookupResponseTimeZoneBuilder {
    ...
    pub fn dst_start(mut self, value: GeolocationLookupResponseTimeZoneDstStart) -> Self {
        self.dst_start = Some(value);
        self
    }

    pub fn dst_end(mut self, value: GeolocationLookupResponseTimeZoneDstEnd) -> Self {
        self.dst_end = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`GeolocationLookupResponseTimeZone`].
    pub fn build(self) -> Result<GeolocationLookupResponseTimeZone, BuildError> {
        Ok(GeolocationLookupResponseTimeZone {
            name: self.name,
            offset: self.offset,
