...
pub enum TimezoneLookupV2RequestLang {
    En,
    De,
    Ru,
    Ja,
...
impl Serialize for TimezoneLookupV2RequestLang {
...
impl<'de> Deserialize<'de> for TimezoneLookupV2RequestLang {
...
impl fmt::Display for TimezoneLookupV2RequestLang {
