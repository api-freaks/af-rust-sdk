...
pub struct WeatherTimeSeriesResponseHistoricalValueHourlyItem {
...
impl WeatherTimeSeriesResponseHistoricalValueHourlyItem {
    pub fn builder() -> WeatherTimeSeriesResponseHistoricalValueHourlyItemBuilder {
        <WeatherTimeSeriesResponseHistoricalValueHourlyItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct WeatherTimeSeriesResponseHistoricalValueHourlyItemBuilder {
...
impl WeatherTimeSeriesResponseHistoricalValueHourlyItemBuilder {
    ...
    /// Consumes the builder and constructs a [`WeatherTimeSeriesResponseHistoricalValueHourlyItem`].
    pub fn build(self) -> Result<WeatherTimeSeriesResponseHistoricalValueHourlyItem, BuildError> {
        Ok(WeatherTimeSeriesResponseHistoricalValueHourlyItem {
