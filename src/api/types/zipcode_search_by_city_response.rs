...
pub struct ZipcodeSearchByCityResponse {
...
impl ZipcodeSearchByCityResponse {
    pub fn builder() -> ZipcodeSearchByCityResponseBuilder {
        <ZipcodeSearchByCityResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ZipcodeSearchByCityResponseBuilder {
...
impl ZipcodeSearchByCityResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`ZipcodeSearchByCityResponse`].
    pub fn build(self) -> Result<ZipcodeSearchByCityResponse, BuildError> {
        Ok(ZipcodeSearchByCityResponse {
