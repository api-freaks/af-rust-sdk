...
pub struct DomainWhoisLookupResponseDomainRegistrar {
...
impl DomainWhoisLookupResponseDomainRegistrar {
    pub fn builder() -> DomainWhoisLookupResponseDomainRegistrarBuilder {
        <DomainWhoisLookupResponseDomainRegistrarBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupResponseDomainRegistrarBuilder {
...
impl DomainWhoisLookupResponseDomainRegistrarBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupResponseDomainRegistrar`].
    pub fn build(self) -> Result<DomainWhoisLookupResponseDomainRegistrar, BuildError> {
        Ok(DomainWhoisLookupResponseDomainRegistrar {
