...
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactResellerContact {
    /// Contact's full name.
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactResellerContact {
    pub fn builder(
    ) -> BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactResellerContactBuilder
    {
        <BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactResellerContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactResellerContactBuilder {
    name: Option<String>,
...
impl BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactResellerContactBuilder {
    ...
    /// Consumes the builder and constructs a [`BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactResellerContact`].
    pub fn build(
        self,
    ) -> Result<
