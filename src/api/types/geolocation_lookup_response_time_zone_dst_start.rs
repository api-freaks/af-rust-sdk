...
pub struct GeolocationLookupResponseTimeZoneDstStart {
...
impl GeolocationLookupResponseTimeZoneDstStart {
    pub fn builder() -> GeolocationLookupResponseTimeZoneDstStartBuilder {
        <GeolocationLookupResponseTimeZoneDstStartBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GeolocationLookupResponseTimeZoneDstStartBuilder {
...
impl GeolocationLookupResponseTimeZoneDstStartBuilder {
    ...
    /// Consumes the builder and constructs a [`GeolocationLookupResponseTimeZoneDstStart`].
    pub fn build(self) -> Result<GeolocationLookupResponseTimeZoneDstStart, BuildError> {
        Ok(GeolocationLookupResponseTimeZoneDstStart {
