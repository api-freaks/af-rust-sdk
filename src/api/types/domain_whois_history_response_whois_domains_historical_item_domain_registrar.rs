...
pub struct DomainWhoisHistoryResponseWhoisDomainsHistoricalItemDomainRegistrar {
...
impl DomainWhoisHistoryResponseWhoisDomainsHistoricalItemDomainRegistrar {
    pub fn builder() -> DomainWhoisHistoryResponseWhoisDomainsHistoricalItemDomainRegistrarBuilder {
        <DomainWhoisHistoryResponseWhoisDomainsHistoricalItemDomainRegistrarBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisHistoryResponseWhoisDomainsHistoricalItemDomainRegistrarBuilder {
...
impl DomainWhoisHistoryResponseWhoisDomainsHistoricalItemDomainRegistrarBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisHistoryResponseWhoisDomainsHistoricalItemDomainRegistrar`].
    pub fn build(
        self,
    ) -> Result<DomainWhoisHistoryResponseWhoisDomainsHistoricalItemDomainRegistrar, BuildError>
    {
        Ok(
