...
pub struct DomainWhoisLookupResponseResellerContact {
...
impl DomainWhoisLookupResponseResellerContact {
    pub fn builder() -> DomainWhoisLookupResponseResellerContactBuilder {
        <DomainWhoisLookupResponseResellerContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DomainWhoisLookupResponseResellerContactBuilder {
    name: Option<String>,
...
impl DomainWhoisLookupResponseResellerContactBuilder {
    ...
    /// Consumes the builder and constructs a [`DomainWhoisLookupResponseResellerContact`].
    pub fn build(self) -> Result<DomainWhoisLookupResponseResellerContact, BuildError> {
        Ok(DomainWhoisLookupResponseResellerContact {
            name: self.name,
