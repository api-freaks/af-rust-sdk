...
pub struct HistoricalWeatherResponseHistoricalDaily {
...
impl HistoricalWeatherResponseHistoricalDaily {
    pub fn builder() -> HistoricalWeatherResponseHistoricalDailyBuilder {
        <HistoricalWeatherResponseHistoricalDailyBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct HistoricalWeatherResponseHistoricalDailyBuilder {
...
impl HistoricalWeatherResponseHistoricalDailyBuilder {
    ...
    /// Consumes the builder and constructs a [`HistoricalWeatherResponseHistoricalDaily`].
    pub fn build(self) -> Result<HistoricalWeatherResponseHistoricalDaily, BuildError> {
        Ok(HistoricalWeatherResponseHistoricalDaily {
