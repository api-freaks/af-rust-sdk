...
pub struct FloodForecastResponseLocationCity {
...
impl FloodForecastResponseLocationCity {
    pub fn builder() -> FloodForecastResponseLocationCityBuilder {
        <FloodForecastResponseLocationCityBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct FloodForecastResponseLocationCityBuilder {
...
impl FloodForecastResponseLocationCityBuilder {
    ...
    /// Consumes the builder and constructs a [`FloodForecastResponseLocationCity`].
    /// This method will fail if any of the following fields are not set:
    /// - [`location_string`](FloodForecastResponseLocationCityBuilder::location_string)
    /// - [`country_name`](FloodForecastResponseLocationCityBuilder::country_name)
    /// - [`state_prov`](FloodForecastResponseLocationCityBuilder::state_prov)
    /// - [`city`](FloodForecastResponseLocationCityBuilder::city)
    /// - [`latitude`](FloodForecastResponseLocationCityBuilder::latitude)
    /// - [`longitude`](FloodForecastResponseLocationCityBuilder::longitude)
    /// - [`timezone`](FloodForecastResponseLocationCityBuilder::timezone)
    /// - [`timezone_abbreviation`](FloodForecastResponseLocationCityBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<FloodForecastResponseLocationCity, BuildError> {
        Ok(FloodForecastResponseLocationCity {
