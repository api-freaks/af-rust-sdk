...
pub struct CurrentWeatherResponseLocationContinentCode {
...
impl CurrentWeatherResponseLocationContinentCode {
    pub fn builder() -> CurrentWeatherResponseLocationContinentCodeBuilder {
        <CurrentWeatherResponseLocationContinentCodeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CurrentWeatherResponseLocationContinentCodeBuilder {
...
impl CurrentWeatherResponseLocationContinentCodeBuilder {
    ...
    /// Consumes the builder and constructs a [`CurrentWeatherResponseLocationContinentCode`].
    /// This method will fail if any of the following fields are not set:
    /// - [`continent_code`](CurrentWeatherResponseLocationContinentCodeBuilder::continent_code)
    /// - [`continent_name`](CurrentWeatherResponseLocationContinentCodeBuilder::continent_name)
    /// - [`country_code2`](CurrentWeatherResponseLocationContinentCodeBuilder::country_code2)
    /// - [`country_code3`](CurrentWeatherResponseLocationContinentCodeBuilder::country_code3)
    /// - [`country_name`](CurrentWeatherResponseLocationContinentCodeBuilder::country_name)
    /// - [`country_name_official`](CurrentWeatherResponseLocationContinentCodeBuilder::country_name_official)
    /// - [`state_prov`](CurrentWeatherResponseLocationContinentCodeBuilder::state_prov)
    /// - [`city`](CurrentWeatherResponseLocationContinentCodeBuilder::city)
    /// - [`latitude`](CurrentWeatherResponseLocationContinentCodeBuilder::latitude)
    /// - [`longitude`](CurrentWeatherResponseLocationContinentCodeBuilder::longitude)
    /// - [`timezone`](CurrentWeatherResponseLocationContinentCodeBuilder::timezone)
    /// - [`timezone_abbreviation`](CurrentWeatherResponseLocationContinentCodeBuilder::timezone_abbreviation)
    pub fn build(self) -> Result<CurrentWeatherResponseLocationContinentCode, BuildError> {
        Ok(CurrentWeatherResponseLocationContinentCode {
            continent_code: self
                .continent_code
